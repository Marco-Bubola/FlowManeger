...
<div class="group space-y-4">
    <label for="<?php echo e($id); ?>" class="flex items-center text-lg font-bold text-slate-800 dark:text-slate-200 group-hover:text-<?php echo e($iconColor); ?>-600 dark:group-hover:text-<?php echo e($iconColor); ?>-400 transition-colors duration-300">
        <div class="flex items-center justify-center w-10 h-10 bg-gradient-to-br <?php echo e($iconColorClass); ?> rounded-xl mr-4 shadow-lg group-hover:scale-110 transition-all duration-300 group-hover:shadow-xl group-hover:shadow-<?php echo e($iconColor); ?>-500/30">
    ...
    <div class="relative flex items-center <?php echo e($width); ?>">
        <!-- Botão Decrementar Modernizado -->
        <button type="button"
                onclick="decrementQuantity_<?php echo e($id); ?>()"
                <?php if($disabled): ?> disabled <?php endif; ?>
                class="group/btn relative flex items-center justify-center h-14 w-14
                       bg-gradient-to-br from-slate-100 to-slate-200
                       dark:from-slate-700 dark:to-slate-600
                       hover:from-<?php echo e($iconColor); ?>-100 hover:to-<?php echo e($iconColor); ?>-200
                       dark:hover:from-<?php echo e($iconColor); ?>-900/50 dark:hover:to-<?php echo e($iconColor); ?>-800/50
                       border-2 <?php echo e($borderErrorColor); ?> <?php echo e($hoverBorderColor); ?>

                       rounded-2xl shadow-lg hover:shadow-xl
                       transition-all duration-300 transform hover:scale-105
                       <?php echo e($focusRingColor); ?> focus:ring-4 focus:outline-none
                       <?php echo e($disabled ? 'opacity-50 cursor-not-allowed' : ''); ?>">

            <!-- Ícone com animação -->
            <svg class="w-4 h-4 text-slate-600 dark:text-slate-300 group-hover/btn:text-<?php echo e($iconColor); ?>-600 dark:group-hover/btn:text-<?php echo e($iconColor); ?>-400 transition-colors duration-300 transform group-hover/btn:scale-110"
            ...
            <!-- Efeito de ripple -->
            <div class="absolute inset-0 rounded-2xl bg-<?php echo e($iconColor); ?>-400/20 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"></div>
        </button>
        ...
        <input type="number"
               ...
               class="bg-white/80 dark:bg-slate-700/80 backdrop-blur-sm border-y-2 border-x-0
                      ...
                      <?php echo e($focusBorderColor); ?> focus:ring-4 <?php echo e($focusRingColor); ?> focus:outline-none
                      transition-all duration-300
                      <?php echo e($disabled ? 'opacity-50 cursor-not-allowed' : ''); ?>"
               placeholder="<?php echo e($placeholder); ?>"
               onchange="updateWireModel_<?php echo e($id); ?>(this.value)">

        <!-- Botão Incrementar Modernizado -->
        <button type="button"
                onclick="incrementQuantity_<?php echo e($id); ?>()"
                <?php if($disabled): ?> disabled <?php endif; ?>
                class="group/btn relative flex items-center justify-center h-14 w-14
                       bg-gradient-to-br from-slate-100 to-slate-200
                       dark:from-slate-700 dark:to-slate-600
...
<script>
    function incrementQuantity_<?php echo e($id); ?>() {
        const input = document.getElementById('<?php echo e($id); ?>');
        const currentValue = parseInt(input.value) || <?php echo e($min); ?>;

        let newValue = currentValue + 1;
        const maxValue = <?php echo e($max ?? 'null'); ?>;
        ...
        updateWireModel_<?php echo e($id); ?>(newValue);
    }    function decrementQuantity_<?php echo e($id); ?>() {
        const input = document.getElementById('<?php echo e($id); ?>');
        const currentValue = parseInt(input.value) || <?php echo e($min); ?>;

        let newValue = currentValue - 1;
        const minValue = <?php echo e($min); ?>;
    ...
    function updateWireModel_<?php echo e($id); ?>(value) {
        window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('<?php echo e($wireModel); ?>', value);
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (input) {
            ...
            input.addEventListener('input', function() {
                ...
                const min = parseInt('<?php echo e($min); ?>');
                const max = <?php echo e($max ?? 'null'); ?>;
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/components/quantity-input.blade.php ENDPATH**/ ?>