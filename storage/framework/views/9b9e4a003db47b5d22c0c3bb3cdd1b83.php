        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="relative w-20 h-20 rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-white to-slate-100 dark:from-slate-700 dark:to-slate-600 flex items-center justify-center group">
                    <!--[if BLOCK]><![endif]--><?php if($mainProduct->image): ?>
                    <img src="<?php echo e(asset('storage/products/' . $mainProduct->image)); ?>"
                        alt="<?php echo e($mainProduct->name); ?>"
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-3 flex-wrap">
                        ...
                        <span class="inline-flex items-center px-3 py-1.5 rounded-xl text-sm font-semibold bg-white/80 dark:bg-slate-700/80 text-purple-700 dark:text-purple-300 shadow-lg border border-purple-200 dark:border-purple-700">
                            <i class="<?php echo e($this->getCategoryIcon($category->icone)); ?> mr-1.5"></i>
                            <?php echo e($category->name); ?>

                        </span>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <span class="inline-flex items-center px-4 py-2 rounded-xl text-sm font-semibold shadow-lg border
                            <?php echo e($products->count() > 1 ? 'bg-gradient-to-r from-amber-500 to-orange-500 text-white border-amber-300' : 'bg-gradient-to-r from-green-500 to-emerald-500 text-white border-green-300'); ?>">
                            <i class="bi bi-layers mr-2"></i>
                            <?php echo e($products->count()); ?> <?php echo e($products->count() === 1 ? 'variação' : 'variações'); ?>
            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <div class="flex items-center gap-2 px-4 py-2 bg-white/60 dark:bg-slate-700/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-slate-600/50">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-bold text-slate-800 dark:text-slate-200"><?php echo e(number_format($analytics['total_quantity_sold'])); ?></div>
                        </div>
                    </div>
                    <div class="flex items-center gap-2 px-4 py-2 bg-white/60 dark:bg-slate-700/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-slate-600/50">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-bold text-slate-800 dark:text-slate-200">R$ <?php echo e(number_format($analytics['total_revenue'], 0, ',', '.')); ?></div>
                        </div>
                    </div>
                    <div class="flex items-center gap-2 px-4 py-2 bg-white/60 dark:bg-slate-700/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-slate-600/50">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-bold text-slate-800 dark:text-slate-200"><?php echo e(number_format($analytics['total_stock'])); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <a href="<?php echo e(route('products.edit', $mainProduct)); ?>"
                    ...
                    <button wire:click="$dispatch('openExportModal', { productId: <?php echo e($mainProduct->id); ?> })"
                    ...
                    <button wire:click="duplicateProduct(<?php echo e($mainProduct->id); ?>)"
                    ...
                    <button wire:click="confirmDelete(<?php echo e($mainProduct->id); ?>)"
    ...
    <div class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/50 p-2">
        <nav class="grid grid-cols-2 md:grid-cols-4 gap-2">
            ...
            <button @click="activeTab = 'variations'"
                ...
                <span x-show="activeTab !== 'variations'" class="absolute -top-1 -right-1 px-2 py-0.5 bg-orange-500 text-white text-xs font-bold rounded-full"><?php echo e($products->count()); ?></span>
                ...
                <div class="group relative bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-700 rounded-3xl p-8 text-white shadow-2xl hover:shadow-blue-500/30 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 overflow-hidden">
                    ...
                    <div class="relative flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-4xl font-black mb-2 group-hover:scale-110 transition-transform duration-300"><?php echo e(number_format($analytics['total_quantity_sold'])); ?></p>
                ...
                <div class="group relative bg-gradient-to-br from-green-500 via-emerald-600 to-teal-700 rounded-3xl p-8 text-white shadow-2xl hover:shadow-green-500/30 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 overflow-hidden">
                    ...
                    <div class="relative flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-4xl font-black mb-2 group-hover:scale-110 transition-transform duration-300">R$ <?php echo e(number_format($analytics['total_revenue'], 0, ',', '.')); ?></p>
                ...
                <div class="group relative bg-gradient-to-br from-purple-500 via-violet-600 to-pink-700 rounded-3xl p-8 text-white shadow-2xl hover:shadow-purple-500/30 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 overflow-hidden">
                    ...
                    <div class="relative flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-4xl font-black mb-2 group-hover:scale-110 transition-transform duration-300">R$ <?php echo e(number_format($analytics['total_profit'], 0, ',', '.')); ?></p>
                            <div class="flex items-center space-x-2">
                                <p class="text-purple-200 text-sm font-medium"><?php echo e(number_format($analytics['profit_margin'], 1)); ?>% margem</p>
                ...
                <div class="group relative bg-gradient-to-br from-orange-500 via-red-600 to-pink-700 rounded-3xl p-8 text-white shadow-2xl hover:shadow-orange-500/30 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 overflow-hidden">
                    ...
                    <div class="relative flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-4xl font-black mb-2 group-hover:scale-110 transition-transform duration-300"><?php echo e(number_format($analytics['total_stock'])); ?></p>
                            <p class="text-orange-200 text-sm font-medium">R$ <?php echo e(number_format($analytics['stock_value'], 0, ',', '.')); ?> em valor</p>
                        </div>
                        <div class="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-500 shadow-lg">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-10">
                ...
                <div class="group relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border border-white/20 dark:border-slate-700/50 overflow-hidden">
                    ...
                    <div class="relative space-y-4 max-h-80 overflow-y-auto custom-scrollbar">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $analytics['top_clients']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="group/item relative flex items-center justify-between p-5 bg-gradient-to-r from-slate-50/80 to-white/60 dark:from-slate-700/80 dark:to-slate-600/60 backdrop-blur-sm rounded-2xl border border-white/30 dark:border-slate-600/30 hover:shadow-lg transition-all duration-300 transform hover:scale-102">
                            <!-- Ranking badge -->
                            <div class="absolute -top-2 -left-2 w-8 h-8 bg-gradient-to-r <?php echo e($index === 0 ? 'from-yellow-400 to-yellow-500' : ($index === 1 ? 'from-gray-400 to-gray-500' : 'from-orange-400 to-orange-500')); ?> rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg">
                                <?php echo e($index + 1); ?>
                            ...
                            <div class="flex items-center space-x-4 flex-1">
                                ...
                                <div class="flex-1">
                                    <p class="font-bold text-slate-800 dark:text-slate-100 group-hover/item:text-blue-600 dark:group-hover/item:text-blue-400 transition-colors duration-300"><?php echo e($client->name); ?></p>
                                    <div class="flex items-center space-x-3 mt-1">
                                        <span class="inline-flex items-center px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-lg text-xs font-medium">
                                            ...
                                            <?php echo e($client->total_orders); ?> pedidos
                                        </span>
                                        <span class="inline-flex items-center px-2 py-1 bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 rounded-lg text-xs font-medium">
                                            ...
                                            <?php echo e($client->total_quantity); ?> un.
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="font-black text-xl text-green-600 dark:text-green-400">R$ <?php echo e(number_format($client->total_spent, 0, ',', '.')); ?></p>
            ...
            <div class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 dark:border-slate-700/50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl border border-blue-200/50 dark:border-blue-700/50">
                        ...
                        <p class="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-2">R$ <?php echo e(number_format($mainProduct->price, 2, ',', '.')); ?></p>
                    </div>
                    <div class="p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl border border-green-200/50 dark:border-green-700/50">
                        ...
                        <p class="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-2">R$ <?php echo e(number_format($mainProduct->price_sale, 2, ',', '.')); ?></p>
                    </div>
                    <div class="p-4 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl border border-purple-200/50 dark:border-purple-700/50">
                        ...
                        <p class="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-2">
                            <?php echo e($analytics['first_sale_date'] ? \Carbon\Carbon::parse($analytics['first_sale_date'])->format('d/m/Y') : 'Nunca'); ?>
                    ...
                    <div class="p-4 bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-2xl border border-orange-200/50 dark:border-orange-700/50">
                        ...
                        <p class="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-2">
                            <?php echo e($analytics['last_sale_date'] ? \Carbon\Carbon::parse($analytics['last_sale_date'])->format('d/m/Y') : 'Nunca'); ?>
                    ...
                    <div class="p-4 bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 rounded-2xl border border-cyan-200/50 dark:border-cyan-700/50">
                        ...
                        <p class="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-2">R$ <?php echo e(number_format($analytics['avg_sale_price'], 2, ',', '.')); ?></p>
                    </div>
                    <div class="p-4 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-2xl border border-emerald-200/50 dark:border-emerald-700/50">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium mt-2 <?php echo e($mainProduct->status === 'ativo' ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200' : ($mainProduct->status === 'inativo' ? 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200' : 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200')); ?>">
                            <i class="bi bi-<?php echo e($mainProduct->status === 'ativo' ? 'check-circle' : ($mainProduct->status === 'inativo' ? 'pause-circle' : 'x-circle')); ?> mr-2"></i>
                            <?php echo e(ucfirst($mainProduct->status)); ?>

                        </span>
                    </div>
                </div>

                <!--[if BLOCK]><![endif]--><?php if($mainProduct->description): ?>
                <div class="mt-8 p-6 bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-800/50 dark:to-gray-800/50 rounded-2xl border border-slate-200/50 dark:border-slate-700/50">
                    ...
                    <p class="text-slate-700 dark:text-slate-300 leading-relaxed"><?php echo e($mainProduct->description); ?></p>
                </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
        </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="space-y-6">
                            <div class="flex justify-between items-center p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl">
                                ...
                                <span class="text-xl font-bold text-blue-600 dark:text-blue-400">R$ <?php echo e(number_format($analytics['avg_sale_price'], 2, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl">
                                ...
                                <span class="text-xl font-bold text-green-600 dark:text-green-400"><?php echo e(number_format($analytics['profit_margin'], 1)); ?>%</span>
                            </div>
                            <div class="flex justify-between items-center p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl">
                                ...
                                <span class="text-xl font-bold text-purple-600 dark:text-purple-400">
                                    <?php echo e($analytics['total_revenue'] > 0 ? number_format(($analytics['total_profit'] / ($analytics['total_revenue'] - $analytics['total_profit'])) * 100, 1) : '0'); ?>%
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex justify-between items-center p-4 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-xl">
                                ...
                                <span class="text-lg font-semibold text-orange-600 dark:text-orange-400">
                                    <!--[if BLOCK]><![endif]--><?php if($analytics['first_sale_date'] && $analytics['last_sale_date']): ?>
                                        <?php echo e(\Carbon\Carbon::parse($analytics['first_sale_date'])->diffInDays(\Carbon\Carbon::parse($analytics['last_sale_date'])) + 1); ?>
                    ...
                    <div class="relative">
                        ...
                        <div class="space-y-6">
                            <div class="flex justify-between items-center p-4 bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 rounded-xl">
                                ...
                                <span class="text-xl font-bold text-purple-600 dark:text-purple-400">R$ <?php echo e(number_format($analytics['stock_value'], 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between items-center p-4 bg-gradient-to-r from-green-50 to-teal-50 dark:from-green-900/20 dark:to-teal-900/20 rounded-xl">
                                ...
                                <span class="text-xl font-bold text-green-600 dark:text-green-400">
                                    <?php echo e($analytics['total_stock'] > 0 ? number_format($analytics['total_quantity_sold'] / $analytics['total_stock'], 2) : '0'); ?>x
                                </span>
                            </div>
                            <div class="flex justify-between items-center p-4 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-xl">
                                <span class="text-slate-600 dark:text-slate-400 font-medium flex items-center">
                                ...
                                <span class="text-xl font-bold text-orange-600 dark:text-orange-400">
                                    ...
                                    ?>
                                    <?php echo e($coverageDays > 0 ? number_format($coverageDays, 0) : '∞'); ?>
        ...
        <div x-show="activeTab === 'sales'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0">
            <div class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/20 dark:border-slate-700/50">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="hidden sm:flex items-center space-x-4">
                            <div class="px-4 py-2 bg-blue-100 dark:bg-blue-900 rounded-xl">
                                <span class="text-sm font-bold text-blue-800 dark:text-blue-200"><?php echo e($salesData->count() ?? 0); ?> vendas</span>
                            </div>
                            <div class="px-4 py-2 bg-green-100 dark:bg-green-900 rounded-xl">
                                <span class="text-sm font-bold text-green-800 dark:text-green-200">R$ <?php echo e(number_format(($salesData ? $salesData->sum('total_price') : 0), 0, ',', '.')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>

                <!--[if BLOCK]><![endif]--><?php if(isset($salesData) && $salesData->isNotEmpty()): ?>
                <div class="p-6">
                    <!-- Filtros e Controles -->
                    ...
                    <div class="overflow-x-auto bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-lg relative">
                        ...
                        <table class="w-full sales-table">
                            ...
                            <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $salesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center space-x-3">
                                            <div class="w-10 h-10 bg-gradient-to-r <?php echo e($gradient); ?> rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-lg">
                                                #<?php echo e($orderNumber); ?>

                                            </div>
                                            <div>
                                                <div class="text-sm font-medium text-slate-900 dark:text-slate-100">#VENDA-<?php echo e(date('Y')); ?>-<?php echo e($orderNumber); ?></div>
                                                <div class="text-sm text-slate-500 dark:text-slate-400">
                                                    <?php echo e($saleType); ?>

                                                    <!--[if BLOCK]><![endif]--><?php if($sale->tipo_pagamento === 'parcelado' && $sale->parcelas > 1): ?>
                                                        • <?php echo e($sale->parcelas); ?>x
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center space-x-3">
                                            <div class="w-8 h-8 bg-gradient-to-r <?php echo e($avatarGradient); ?> rounded-full flex items-center justify-center text-white text-xs font-bold">
                                                <?php echo e($initials); ?>

                                            </div>
                                            <div>
                                                <div class="text-sm font-medium text-slate-900 dark:text-slate-100"><?php echo e($clientName); ?></div>
                                                <!--[if BLOCK]><![endif]--><?php if($clientEmail): ?>
                                                <div class="text-sm text-slate-500 dark:text-slate-400"><?php echo e($clientEmail); ?></div>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-slate-900 dark:text-slate-100"><?php echo e($sale->created_at->format('d/m/Y')); ?></div>
                                        <div class="text-sm text-slate-500 dark:text-slate-400"><?php echo e($sale->created_at->format('H:i')); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium quantity-badge">
                                                <?php echo e($totalQuantity); ?> <?php echo e($totalQuantity == 1 ? 'unidade' : 'unidades'); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium status-badge <?php echo e($status['bg']); ?> <?php echo e($status['text']); ?> border <?php echo e($status['border']); ?>">
                                            <i class="bi <?php echo e($status['icon']); ?> mr-1"></i>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center space-x-2">
                                            <button class="action-button p-2 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors duration-200 tooltip" title="Ver detalhes" data-tooltip="Ver detalhes" onclick="window.location.href='<?php echo e(route('sales.show', $sale->id)); ?>'">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($sale->status !== 'cancelada'): ?>
                                            <button class="action-button p-2 text-purple-600 hover:text-purple-800 dark:text-purple-400 dark:hover:text-purple-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-lg transition-colors duration-200 tooltip" title="Duplicar" data-tooltip="Duplicar" wire:click="duplicateSale(<?php echo e($sale->id); ?>)">
                                                <i class="bi bi-files text-sm"></i>
                                            </button>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <!--[if BLOCK]><![endif]--><?php if($sale->status === 'pendente'): ?>
                                            <button class="action-button p-2 text-orange-600 hover:text-orange-800 dark:text-orange-400 dark:hover:text-orange-300 hover:bg-orange-50 dark:hover:bg-orange-900/20 rounded-lg transition-colors duration-200 tooltip" title="Editar" data-tooltip="Editar" onclick="window.location.href='<?php echo e(route('sales.edit', $sale->id)); ?>'">
                    ...
                    <div class="mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div class="flex items-center space-x-4 text-sm text-slate-600 dark:text-slate-400">
                            ...
                            ?>
                            <span>Mostrando <span class="font-medium text-slate-900 dark:text-slate-100"><?php echo e($startItem); ?>-<?php echo e($endItem); ?></span> de <span class="font-medium text-slate-900 dark:text-slate-100"><?php echo e($totalSales); ?></span> vendas</span>
                            <div class="h-4 w-px bg-slate-300 dark:bg-slate-600"></div>
                            <span>Total vendido: <span class="font-bold text-green-600 dark:text-green-400">R$ <?php echo e(number_format($totalValue, 2, ',', '.')); ?></span></span>
                        </div>

                        <!--[if BLOCK]><![endif]--><?php if($salesData instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
                        <nav class="flex items-center space-x-1">
                            <!--[if BLOCK]><![endif]--><?php if($salesData->onFirstPage()): ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $salesData->getUrlRange(max(1, $salesData->currentPage() - 2), min($salesData->lastPage(), $salesData->currentPage() + 2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!--[if BLOCK]><![endif]--><?php if($page == $salesData->currentPage()): ?>
                                    <button class="pagination-button px-3 py-2 text-sm font-medium bg-blue-600 text-white rounded-lg shadow-sm"><?php echo e($page); ?></button>
                                <?php else: ?>
                                    <button class="pagination-button px-3 py-2 text-sm font-medium text-slate-700 hover:text-slate-900 dark:text-slate-300 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition-colors duration-200" wire:click="gotoPage(<?php echo e($page); ?>)"><?php echo e($page); ?></button>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->

                            <!--[if BLOCK]><![endif]--><?php if($salesData->hasMorePages()): ?>
                        ...
                        <div class="stats-card bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6 border border-blue-200/50 dark:border-blue-700/50">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($currentMonthSales); ?></p>
                                    <p class="text-sm text-slate-500 dark:text-slate-400">
                                        <!--[if BLOCK]><![endif]--><?php if($salesGrowth > 0): ?>
                                            +<?php echo e(number_format($salesGrowth, 1)); ?>% vs mês anterior
                        ...
                        <div class="stats-card bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl p-6 border border-green-200/50 dark:border-green-700/50">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-slate-900 dark:text-slate-100 currency-field">R$ <?php echo e(number_format($averageTicket, 2, ',', '.')); ?></p>
                                    <p class="text-sm text-slate-500 dark:text-slate-400">
                                        <!--[if BLOCK]><![endif]--><?php if($ticketGrowth > 0): ?>
                                            +<?php echo e(number_format($ticketGrowth, 1)); ?>% vs mês anterior
                                        <?php elseif($ticketGrowth < 0): ?>
                                            <?php echo e(number_format($ticketGrowth, 1)); ?>% vs mês anterior
                                        <?php else: ?>
                                            Sem variação
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="stats-card bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-6 border border-purple-200/50 dark:border-purple-700/50">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($uniqueClients); ?></p>
                                    <p class="text-sm text-slate-500 dark:text-slate-400">
                                        <!--[if BLOCK]><![endif]--><?php if($newClientsThisMonth > 0): ?>
                                            +<?php echo e($newClientsThisMonth); ?> <?php echo e($newClientsThisMonth == 1 ? 'novo cliente' : 'novos clientes'); ?>
                ...
                <div class="text-center py-20">
                    ...
                    <div class="mt-6">
                        <!--[if BLOCK]><![endif]--><?php if(Route::has('sales.create')): ?>
                        <a href="<?php echo e(route('sales.create')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                ...
                <div class="product-card-modern">
                    ...
                    <div class="btn-action-group">
                        <a href="<?php echo e(route('products.show', $product->product_code)); ?>" class="btn btn-secondary" title="Ver Detalhes">
                            <i class="bi bi-eye"></i>
                        </a>
                        <a href="<?php echo e(route('products.edit', $product)); ?>" class="btn btn-primary" title="Editar">
                            <i class="bi bi-pencil-square"></i>
                        </a>
                        <button type="button"
                                wire:click="$dispatch('openExportModal', { productId: <?php echo e($product->id); ?> })"
                    ...
                    <div class="product-img-area">
                        <img src="<?php echo e(asset('storage/products/' . $product->image)); ?>" class="product-img" alt="<?php echo e($product->name); ?>">
                        ...
                        <div class="price-area mt-3">
                            <div class="flex flex-col gap-2">
                                ...
                                <span class="badge-price-sale" title="Preço de Venda">
                                    ...
                                    R$ <?php echo e(number_format($product->price_sale, 2, ',', '.')); ?>
...
[$__name, $__params] = $__split('products.export-product-card');

$__html = app('livewire')->mount($__name, $__params, 'lw-3009349158-0', $__slots ?? [], get_defined_vars());
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    ?>
    const chartData = <?php echo json_encode($chartData ?? $defaultChartData); ?>;
    ...
    function initVariationChart() {
        ...
        ?>
        const variations = <?php echo json_encode($analytics['variation_performance'] ?? $defaultVariations); ?>;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/products/show-product.blade.php ENDPATH**/ ?>