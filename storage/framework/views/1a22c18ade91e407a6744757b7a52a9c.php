<div x-data="{ showFilters: false, showDeleteModal: <?php if ((object) ('showDeleteModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showDeleteModal'->value()); ?>')<?php echo e('showDeleteModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showDeleteModal'); ?>')<?php endif; ?>.live }" class=" w-full ">
    <style>
        [x-cloak] {
    ...
    <div class="">
        ...
        <!-- Header Moderno -->
        <?php if (isset($component)) { $__componentOriginal1f93f1f85f0b276a8894e645547876e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1f93f1f85f0b276a8894e645547876e9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.clients-index-header','data' => ['title' => 'Clientes','totalClients' => $clients->total() ?? 0,'activeClients' => $clients->where('status', 'ativo')->count() ?? 0,'premiumClients' => $clients->where('type', 'premium')->count() ?? 0,'newClientsThisMonth' => $clients->where('created_at', '>=', now()->startOfMonth())->count() ?? 0,'showQuickActions' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('clients-index-header'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Clientes','total-clients' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clients->total() ?? 0),'active-clients' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clients->where('status', 'ativo')->count() ?? 0),'premium-clients' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clients->where('type', 'premium')->count() ?? 0),'new-clients-this-month' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clients->where('created_at', '>=', now()->startOfMonth())->count() ?? 0),'show-quick-actions' => true]); ?>
                        ...
                        <div class="flex items-center gap-2">
                            <div
                                ...
                                <div class="text-sm font-semibold text-slate-800 dark:text-slate-200">
                                    <?php echo e($clients->total()); ?> Clientes
                                </div>
                                <span class="text-xs text-slate-500 dark:text-slate-400">
                                    <?php echo e($clients->firstItem() ?? 0); ?>-<?php echo e($clients->lastItem() ?? 0); ?>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($clients->hasPages()): ?>
                            <div
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($clients->previousPageUrl()): ?>
                                ...
                                <div class="flex items-center px-3 py-1">
                                    <span class="text-sm font-medium text-slate-700 dark:text-slate-300">
                                        <?php echo e($clients->currentPage()); ?> / <?php echo e($clients->lastPage()); ?>

                                    </span>
                                </div>
                                <!--[if BLOCK]><![endif]--><?php if($clients->nextPageUrl()): ?>
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                ...
                                <span class="text-sm font-semibold text-slate-800 dark:text-slate-300">
                                    Por
                                    <?php echo e(match ($sortBy ?? 'name') {'created_at' => 'Data','name' => 'Nome','email' => 'Email','status' => 'Status','phone' => 'Telefone','most_sales' => 'Compras',default => 'Nome'}); ?>

                                </span>
                                <button wire:click="toggleSort('<?php echo e($sortBy); ?>')">
                                    <i class="bi bi-<?php echo e(($sortDirection ?? 'asc') === 'asc' ? 'arrow-up' : 'arrow-down'); ?>"></i>
                                </button>
                            </div>
                            <div class="hidden lg:flex items-center gap-4 text-sm">
                                <div class="flex items-center gap-1 text-green-600 dark:text-green-400">
                                    <i class="bi bi-person-check"></i>
                                    <span><?php echo e($clients->where('status', 'ativo')->count()); ?> Ativos</span>
                                </div>
                                <div class="flex items-center gap-1 text-purple-600 dark:text-purple-400">
                                    <i class="bi bi-star"></i>
                                    <span><?php echo e($clients->where('type', 'premium')->count()); ?> Premium</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal1f93f1f85f0b276a8894e645547876e9)): ?>
<?php $attributes = $__attributesOriginal1f93f1f85f0b276a8894e645547876e9; ?>
<?php unset($__attributesOriginal1f93f1f85f0b276a8894e645547876e9); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal1f93f1f85f0b276a8894e645547876e9)): ?>
<?php $component = $__componentOriginal1f93f1f85f0b276a8894e645547876e9; ?>
<?php unset($__componentOriginal1f93f1f85f0b276a8894e645547876e9); ?>
<?php endif; ?>
        ...
        <div class="space-y-2">
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <button wire:click="$set('statusFilter', '')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-purple-300 dark:hover:border-purple-500 transition-all duration-200 <?php echo e($statusFilter === '' ? 'ring-2 ring-purple-500 bg-purple-50 dark:bg-purple-900/30' : ''); ?>">
                ...
                <button wire:click="$set('statusFilter', 'ativo')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-green-300 dark:hover:border-green-500 transition-all duration-200 <?php echo e($statusFilter === 'ativo' ? 'ring-2 ring-green-500 bg-green-50 dark:bg-green-900/30' : ''); ?>">
                    <div class="flex items-center justify-center gap-2">
                ...
                <button wire:click="$set('statusFilter', 'inativo')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-red-300 dark:hover:border-red-500 transition-all duration-200 <?php echo e($statusFilter === 'inativo' ? 'ring-2 ring-red-500 bg-red-50 dark:bg-red-900/30' : ''); ?>">
                    <div class="flex items-center justify-center gap-2">
                ...
                <button wire:click="$set('statusFilter', 'premium')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-yellow-300 dark:hover:border-yellow-500 transition-all duration-200 <?php echo e($statusFilter === 'premium' ? 'ring-2 ring-yellow-500 bg-yellow-50 dark:bg-yellow-900/30' : ''); ?>">
                    <div class="flex items-center justify-center gap-2">
        ...
        <div class="space-y-2">
            ...
            <div class="grid grid-cols-3 gap-1">
                ...
                <button wire:click="$set('dateFilter', '')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-indigo-300 dark:hover:border-indigo-500 transition-all duration-200 <?php echo e($dateFilter === '' ? 'ring-2 ring-indigo-500 bg-indigo-50 dark:bg-indigo-900/30' : ''); ?>">
                ...
                <button wire:click="$set('dateFilter', 'hoje')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-blue-300 dark:hover:border-blue-500 transition-all duration-200 <?php echo e($dateFilter === 'hoje' ? 'ring-2 ring-blue-500 bg-blue-50 dark:bg-blue-900/30' : ''); ?>">
                    <div class="text-center">
                ...
                <button wire:click="$set('dateFilter', 'semana')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-green-300 dark:hover:border-green-500 transition-all duration-200 <?php echo e($dateFilter === 'semana' ? 'ring-2 ring-green-500 bg-green-50 dark:bg-green-900/30' : ''); ?>">
                    <div class="text-center">
                ...
                <button wire:click="$set('dateFilter', 'mes')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-purple-300 dark:hover:border-purple-500 transition-all duration-200 <?php echo e($dateFilter === 'mes' ? 'ring-2 ring-purple-500 bg-purple-50 dark:bg-purple-900/30' : ''); ?>">
                    <div class="text-center">
                ...
                <button wire:click="$set('dateFilter', 'ano')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-orange-300 dark:hover:border-orange-500 transition-all duration-200 <?php echo e($dateFilter === 'ano' ? 'ring-2 ring-orange-500 bg-orange-50 dark:bg-orange-900/30' : ''); ?>">
                    <div class="text-center">
        ...
        <div class="space-y-2">
            ...
            <div class="grid grid-cols-3 gap-1">
                ...
                <button wire:click="toggleSort('name')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-emerald-300 dark:hover:border-emerald-500 transition-all duration-200 <?php echo e($sortBy === 'name' ? 'ring-2 ring-emerald-500 bg-emerald-50 dark:bg-emerald-900/30' : ''); ?>">
                    <div class="text-center">
                ...
                <button wire:click="toggleSort('created_at')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-blue-300 dark:hover:border-blue-500 transition-all duration-200 <?php echo e($sortBy === 'created_at' ? 'ring-2 ring-blue-500 bg-blue-50 dark:bg-blue-900/30' : ''); ?>">
                    <div class="text-center">
                ...
                <button wire:click="toggleSort('email')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-purple-300 dark:hover:border-purple-500 transition-all duration-200 <?php echo e($sortBy === 'email' ? 'ring-2 ring-purple-500 bg-purple-50 dark:bg-purple-900/30' : ''); ?>">
                    <div class="text-center">
                ...
                <button wire:click="toggleSort('status')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-orange-300 dark:hover:border-orange-500 transition-all duration-200 <?php echo e($sortBy === 'status' ? 'ring-2 ring-orange-500 bg-orange-50 dark:bg-orange-900/30' : ''); ?>">
                    <div class="text-center">
                ...
                <button wire:click="toggleSort('phone')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-teal-300 dark:hover:border-teal-500 transition-all duration-200 <?php echo e($sortBy === 'phone' ? 'ring-2 ring-teal-500 bg-teal-50 dark:bg-teal-900/30' : ''); ?>">
                    <div class="text-center">
        ...
        <div class="space-y-2">
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <button wire:click="$set('perPage', '12')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-pink-300 dark:hover:border-pink-500 transition-all duration-200 <?php echo e($perPage === '12' ? 'ring-2 ring-pink-500 bg-pink-50 dark:bg-pink-900/30' : ''); ?>">
                    <div class="flex items-center justify-center gap-2">
                ...
                <button wire:click="$set('perPage', '24')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-pink-300 dark:hover:border-pink-500 transition-all duration-200 <?php echo e($perPage === '24' ? 'ring-2 ring-pink-500 bg-pink-50 dark:bg-pink-900/30' : ''); ?>">
                    <div class="flex items-center justify-center gap-2">
                ...
                <button wire:click="$set('perPage', '48')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-pink-300 dark:hover:border-pink-500 transition-all duration-200 <?php echo e($perPage === '48' ? 'ring-2 ring-pink-500 bg-pink-50 dark:bg-pink-900/30' : ''); ?>">
                    <div class="flex items-center justify-center gap-2">
                ...
                <button wire:click="$set('perPage', '96')"
                    class="group p-2 bg-white dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-pink-300 dark:hover:border-pink-500 transition-all duration-200 <?php echo e($perPage === '96' ? 'ring-2 ring-pink-500 bg-pink-50 dark:bg-pink-900/30' : ''); ?>">
                    <div class="flex items-center justify-center gap-2">
            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div x-data="{ expanded: false }"
                    ...
                    <div class="absolute top-2 left-2 z-10">
                        <input type="checkbox" wire:model.live="selectedClients" value="<?php echo e($client->id); ?>"
                    ...
                    <div
                        ...
                        <div class="absolute top-2 right-2">
                            <!--[if BLOCK]><![endif]--><?php if($client->sales->count() >= 10): ?>
                                <span
                            ...
                            <?php elseif($client->sales->count() >= 5): ?>
                                <span
                    ...
                    <div class="flex justify-center -mt-8 mb-2 relative z-10">
                        <div class="relative">
                            <img src="<?php echo e($client->caminho_foto); ?>" alt="Avatar de <?php echo e($client->name); ?>"
                    ...
                    <div class="px-4 pb-4">
                        ...
                        <div class="text-center mb-2">
                            <h3 class="text-base font-bold text-white truncate"><?php echo e($client->name); ?></h3>
                            <div class="flex items-center justify-center gap-2 text-xs text-gray-400">
                                <span class="flex items-center">
                                    <i class="bi bi-envelope text-xs mr-1"></i>
                                    <span class="truncate max-w-[120px]"><?php echo e($client->email ?: 'N/A'); ?></span>
                                </span>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-3 py-3 mb-3">
                            ...
                            <div class="relative bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-xl p-3 hover:border-blue-400 transition-all duration-200">
                                ...
                                <p class="text-[10px] text-gray-400 font-medium">
                                    R$ <?php echo e(number_format($client->sales->sum('total_price'), 0, ',', '.')); ?>
                            ...
                            <div class="relative bg-gradient-to-br from-green-500/10 to-teal-500/10 border border-green-500/20 rounded-xl p-3 hover:border-green-400 transition-all duration-200">
                                ...
                                <p class="text-xl font-bold text-white mb-0.5">
                                    <?php echo e($client->consortiumParticipants ? $client->consortiumParticipants->count() : 0); ?>

                                </p>
                                <p class="text-[10px] text-gray-400 font-medium">
                                    <?php echo e($client->consortiumParticipants ? $client->consortiumParticipants->where('status', 'active')->count() : 0); ?> ativos
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-2 mb-3">
                            <a href="<?php echo e(route('clients.dashboard', $client->id)); ?>"
                            ...
                            <a href="<?php echo e(route('clients.resumo', $client->id)); ?>"
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($client->consortiumParticipants && $client->consortiumParticipants->count() > 0): ?>
                            <a href="<?php echo e(route('clients.consortiums', $client->id)); ?>"
                        ...
                        <div class="grid grid-cols-2 gap-2 text-xs">
                            <button wire:click="openExportModal(<?php echo e($client->id); ?>)"
                            ...
                            <a href="https://wa.me/55<?php echo e(preg_replace('/[^0-9]/', '', $client->phone)); ?>?text=<?php echo e(urlencode('Olá ' . $client->name . ', tudo bem?')); ?>"
                                target="_blank"
...
<?php echo $__env->make('livewire.clients._export-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<!--[if BLOCK]><![endif]--><?php if($clients->hasPages()): ?>
    <div
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-800 dark:text-slate-200">
                        Página <?php echo e($clients->currentPage()); ?> de <?php echo e($clients->lastPage()); ?>

                    </h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">
                        Mostrando <?php echo e($clients->firstItem() ?? 0); ?> - <?php echo e($clients->lastItem() ?? 0); ?> de
                        <?php echo e($clients->total()); ?> <?php echo e($clients->total() === 1 ? 'cliente' : 'clientes'); ?>
            ...
            <div class="flex items-center gap-2">
                <!-- Primeira Página -->
                <!--[if BLOCK]><![endif]--><?php if($clients->currentPage() > 1): ?>
                    <a href="<?php echo e($clients->url(1)); ?>"
                ...
                <div
                    ...
                    <!--[if BLOCK]><![endif]--><?php for($i = $start; $i <= $end; $i++): ?>
                        <!--[if BLOCK]><![endif]--><?php if($i == $clients->currentPage()): ?>
                            <div
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($clients->url($i)); ?>"
                ...
                <!-- Última Página -->
                <?php if($clients->currentPage() < $clients->lastPage()): ?>
                    <a href="<?php echo e($clients->url($clients->lastPage())); ?>"
                        class="group p-3 bg-gradient-to-r from-slate-100 to-slate-200 hover:from-indigo-500 hover:to-purple-600 dark:from-slate-700 dark:to-slate-600 dark:hover:from-indigo-500 dark:hover:to-purple-600 text-slate-600 hover:text-white dark:text-slate-300 dark:hover:text-white rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                        title="Última página">
                        <i
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/clients/clients-index.blade.php ENDPATH**/ ?>