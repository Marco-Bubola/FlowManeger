<div class="min-h-screen flex flex-col">
            ...
            <div class="flex items-center justify-between gap-6">
                ...
                <div class="flex items-center gap-5">
                    ...
                    <div class="space-y-1.5">
                        <nav class="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
                            ...
                            <a href="<?php echo e(route('mercadolivre.products')); ?>" class="hover:text-purple-600 transition-colors">Mercado Livre</a>
                            <i class="bi bi-chevron-right text-[10px]"></i>
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-1.5 px-2.5 py-1 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-lg border border-blue-200 dark:border-blue-700">
                                ...
                                <span class="text-xs font-semibold text-blue-700 dark:text-blue-300"><?php echo e($stats['total']); ?> publicações</span>
                            </div>
                            <div class="flex items-center gap-1.5 px-2.5 py-1 bg-gradient-to-r from-emerald-500/20 to-green-500/20 rounded-lg border border-emerald-200 dark:border-emerald-700">
                                ...
                                <span class="text-xs font-semibold text-emerald-700 dark:text-emerald-300"><?php echo e($stats['active']); ?> ativas</span>
                            </div>
                            <div class="flex items-center gap-1.5 px-2.5 py-1 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-lg border border-purple-200 dark:border-purple-700">
                                ...
                                <span class="text-xs font-semibold text-purple-700 dark:text-purple-300"><?php echo e($stats['kits']); ?> kits</span>
                            </div>
                            <!--[if BLOCK]><![endif]--><?php if($stats['errors'] > 0): ?>
                            <div class="flex items-center gap-1.5 px-2.5 py-1 bg-gradient-to-r from-red-500/20 to-rose-500/20 rounded-lg border border-red-200 dark:border-red-700">
                                ...
                                <span class="text-xs font-semibold text-red-700 dark:text-red-300"><?php echo e($stats['errors']); ?> erros</span>
                            </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if(($stats['only_on_ml'] ?? 0) > 0): ?>
                            <div class="flex items-center gap-1.5 px-2.5 py-1 bg-gradient-to-r from-amber-500/20 to-orange-500/20 rounded-lg border border-amber-200 dark:border-amber-700">
                                ...
                                <span class="text-xs font-semibold text-amber-700 dark:text-amber-300"><?php echo e($stats['only_on_ml']); ?> só no ML</span>
                            </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                    </div>
                ...
                <div class="flex items-center gap-3 flex-wrap justify-end">
                    ...
                    <div class="flex items-center gap-2 px-3 py-2 bg-white/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-600 rounded-xl shadow-md">
                        ...
                        <div class="text-sm">
                            <span class="font-bold text-slate-800 dark:text-slate-200"><?php echo e($publications->total()); ?></span>
                            <span class="text-slate-600 dark:text-slate-400 ml-1"><?php echo e($publications->total() === 1 ? 'publicação' : 'publicações'); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-1.5">
                        <button wire:click="$set('statusFilter', 'all')"
                            class="px-3 py-1.5 rounded-lg text-xs font-semibold transition-all <?php echo e($statusFilter === 'all' ? 'bg-purple-500 text-white shadow-lg shadow-purple-500/30' : 'bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-600 hover:bg-slate-200 dark:hover:bg-slate-600'); ?>">
                            Todos
                        </button>
                        <button wire:click="$set('statusFilter', 'active')"
                            class="px-3 py-1.5 rounded-lg text-xs font-semibold transition-all <?php echo e($statusFilter === 'active' ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/30' : 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 border border-green-200 dark:border-green-700 hover:bg-green-200 dark:hover:bg-green-800'); ?>">
                            Ativas
                        </button>
                        <button wire:click="$set('statusFilter', 'paused')"
                            class="px-3 py-1.5 rounded-lg text-xs font-semibold transition-all <?php echo e($statusFilter === 'paused' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/30' : 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 border border-yellow-200 dark:border-yellow-700 hover:bg-yellow-200 dark:hover:bg-yellow-800'); ?>">
                            Pausadas
                        </button>
                    </div>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($publications->hasPages()): ?>
                    <div class="flex items-center gap-1 bg-white/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-600 rounded-xl p-1 shadow-md">
                        <!--[if BLOCK]><![endif]--><?php if($publications->currentPage() > 1): ?>
                        ...
                        <span class="px-2 text-xs font-medium text-slate-700 dark:text-slate-300">
                            <?php echo e($publications->currentPage()); ?> / <?php echo e($publications->lastPage()); ?>

                        </span>
                        <!--[if BLOCK]><![endif]--><?php if($publications->hasMorePages()): ?>
                    ...
                    <div class="flex items-center gap-1 bg-white/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-600 rounded-xl p-1 shadow-md">
                        <button wire:click="$set('viewMode', 'cards')" 
                                ...
                                class="p-1.5 rounded-lg transition-all <?php echo e($viewMode === 'cards' ? 'bg-purple-500 text-white' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700'); ?>">
                            <i class="bi bi-grid-3x3-gap text-sm"></i>
                        </button>
                        <button wire:click="$set('viewMode', 'table')" 
                                title="Visualizar em Tabela"
                                class="p-1.5 rounded-lg transition-all <?php echo e($viewMode === 'table' ? 'bg-purple-500 text-white' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700'); ?>">
                    ...
                    <a href="<?php echo e(route('mercadolivre.settings')); ?>"
    ...
    <!--[if BLOCK]><![endif]--><?php if($isSyncing || $syncedCount > 0): ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($isSyncing): ?>
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-blue-600 dark:text-blue-400">
                                <?php echo e($syncedCount); ?> de <?php echo e($totalToSync); ?> publicações sincronizadas
                            </p>
                            
                            <!--[if BLOCK]><![endif]--><?php if($totalToSync > 0): ?>
                            <div class="mt-2 w-full bg-blue-200 dark:bg-blue-900 rounded-full h-2 overflow-hidden">
                                <div class="h-full bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full transition-all duration-500" 
                                     style="width: <?php echo e(($syncedCount / $totalToSync) * 100); ?>%"></div>
                            </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                    <?php else: ?>
                        
                        <!--[if BLOCK]><![endif]--><?php if(count($syncErrors) === 0): ?>
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-emerald-600 dark:text-emerald-400">
                                    <?php echo e($syncedCount); ?> de <?php echo e($totalToSync); ?> publicações atualizadas com sucesso
                                </p>
                            </div>
                        <?php else: ?>
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-amber-600 dark:text-amber-400 mb-2">
                                    <?php echo e($syncedCount); ?> sincronizadas · <?php echo e(count($syncErrors)); ?> com erro
                                </p>
                                
                                <?php if(count($syncErrors) > 0): ?>
                                <details class="mt-2">
                                    <summary class="cursor-pointer text-xs font-semibold text-amber-700 dark:text-amber-300 hover:text-amber-800 dark:hover:text-amber-200">
                                        Ver erros (<?php echo e(count($syncErrors)); ?>)
                                    </summary>
                                    <div class="mt-2 space-y-1 max-h-40 overflow-y-auto">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $syncErrors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="p-2 rounded-lg bg-white dark:bg-slate-800 border border-amber-200 dark:border-amber-800">
                                            <p class="text-xs font-semibold text-slate-700 dark:text-slate-300"><?php echo e($error['title']); ?></p>
                                            <p class="text-xs text-red-600 dark:text-red-400"><?php echo e($error['error']); ?></p>
                                        </div>
    ...
    <div class="flex-1 pb-6">
        ...
        <!--[if BLOCK]><![endif]--><?php if($viewMode === 'cards'): ?>
            ...
            <div class="products-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-5 gap-6">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $publications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $publication): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <div class="product-card-modern">
                        ...
                        <div class="product-img-area" style="height: 330px; position: relative; overflow: hidden; background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); display: flex; align-items: center; justify-content: center; padding: 15px;">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($publication->products->count() === 1): ?>
                                
                                <?php $singleProduct = $publication->products->first(); ?>
                                <!--[if BLOCK]><![endif]--><?php if($singleProduct->image && $singleProduct->image !== 'product-placeholder.png'): ?>
                                    <img src="<?php echo e(asset('storage/products/' . $singleProduct->image)); ?>" 
                                         alt="<?php echo e($singleProduct->name); ?>" 
                                ...
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <?php elseif($publication->products->count() === 2): ?>
                                ...
                                <div class="grid grid-cols-2 gap-3 w-full h-full p-2">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $publication->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!--[if BLOCK]><![endif]--><?php if($product->image && $product->image !== 'product-placeholder.png'): ?>
                            ...
                            <?php elseif($publication->products->count() === 3): ?>
                                
                                <div class="grid grid-cols-2 grid-rows-2 gap-3 w-full h-full p-2">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $publication->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!--[if BLOCK]><![endif]--><?php if($product->image && $product->image !== 'product-placeholder.png'): ?>
                                            <div class="relative group overflow-hidden rounded-xl border-2 border-slate-200 shadow-lg bg-white <?php echo e($index === 0 ? 'row-span-2' : ''); ?>">
                                                <img src="<?php echo e(asset('storage/products/' . $product->image)); ?>" 
                                                     alt="<?php echo e($product->name); ?>" 
                                                     class="w-full h-full object-contain p-2 group-hover:scale-105 transition-transform duration-300">
                                            </div>
                                        <?php else: ?>
                                            <div class="flex items-center justify-center bg-slate-200/50 rounded-xl border-2 border-slate-300 <?php echo e($index === 0 ? 'row-span-2' : ''); ?>">
                                                <i class="bi bi-image text-slate-400 text-4xl"></i>
                                            </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <?php else: ?>
                                ...
                                <div class="grid grid-cols-2 grid-rows-2 gap-3 w-full h-full p-2">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $publication->products->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!--[if BLOCK]><![endif]--><?php if($product->image && $product->image !== 'product-placeholder.png'): ?>
                                            <div class="relative group overflow-hidden rounded-xl border-2 border-slate-200 shadow-lg bg-white">
                                                <img src="<?php echo e(asset('storage/products/' . $product->image)); ?>" 
                                                     alt="<?php echo e($product->name); ?>" 
                                ...
                                <?php if($publication->products->count() > 4): ?>
                                    <div class="absolute bottom-16 right-4 z-10">
                                        <span class="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm font-black border-2 border-white shadow-2xl">
                                            ...
                                            +<?php echo e($publication->products->count() - 4); ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($publication->ml_item_id): ?>
                                <span class="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[10px] font-black shadow-lg border-2 border-white" 
                                    ...
                                    <i class="bi bi-tag-fill"></i> <?php echo e(substr($publication->ml_item_id, 0, 12)); ?>...
                                </span>
                            <?php else: ?>
                                <span class="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[10px] font-black shadow-lg border-2 border-white" 
                            ...
                            ?>
                            <span class="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[10px] font-black shadow-lg border-2 border-white" 
                                  style="position: absolute; top: 40px; left: 10px; background: <?php echo e($typeConfig['bg']); ?>; color: white;"
                                  title="Tipo de Publicação">
                                <i class="bi bi-<?php echo e($typeConfig['icon']); ?>"></i> 
                                <?php echo e($typeConfig['text']); ?>

                            </span>

                            
                            <div class="absolute bottom-3 left-3 z-10">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r <?php echo e($statusConfig['color']); ?> text-white shadow-xl border-2 border-white text-xs font-bold">
                            ...
                            <div class="absolute bottom-3 right-3 z-10">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r from-slate-700 to-slate-900 text-white shadow-xl border-2 border-white text-xs font-bold">
                                    <i class="bi bi-stack"></i> <?php echo e($availableQty); ?>
                            ...
                            <div class="absolute bottom-14 left-3 z-10">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-gradient-to-r <?php echo e($syncConfig['color']); ?> text-white shadow-xl border-2 border-white text-[10px] font-bold">
                                    <i class="bi bi-<?php echo e($syncConfig['icon']); ?>"></i>
                                    <?php echo e($syncConfig['text']); ?>
                            ...
                            <div class="absolute top-3 right-3 z-20 flex flex-col gap-2">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($publication->ml_permalink): ?>
                                    <a href="<?php echo e($publication->ml_permalink); ?>" 
                                       target="_blank"
                                ...
                                <a href="<?php echo e(route('mercadolivre.publications.show', $publication->id)); ?>" 
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo e(route('mercadolivre.products.publish', $publication->products->first()->id)); ?>" 
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($publication->ml_item_id): ?>
                                <button wire:click="syncPublication(<?php echo e($publication->id); ?>)" 
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($publication->ml_item_id): ?>
                                <!--[if BLOCK]><![endif]--><?php if($publication->status === 'active'): ?>
                                    <button wire:click="pausePublication(<?php echo e($publication->id); ?>)" 
                                ...
                                <?php elseif($publication->status === 'paused'): ?>
                                    <button wire:click="activatePublication(<?php echo e($publication->id); ?>)" 
                            ...
                            <button wire:click="deletePublication(<?php echo e($publication->id); ?>)" 
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="text-sm font-bold text-slate-800 dark:text-slate-100 mb-3 line-clamp-2 leading-tight min-h-[2.5rem]" title="<?php echo e($publication->title); ?>">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                ...
                                <span class="text-2xl font-black bg-gradient-to-r from-green-600 to-emerald-600 dark:from-green-400 dark:to-emerald-400 bg-clip-text text-transparent">
                                    R$ <?php echo e(number_format($publication->price, 2, ',', '.')); ?>
                            ...
                            <div class="text-right">
                                ...
                                <div class="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-gradient-to-r from-purple-100 to-indigo-100 dark:from-purple-900/30 dark:to-indigo-900/30 border border-purple-300 dark:border-purple-700">
                                    ...
                                    <span class="text-lg font-black text-purple-700 dark:text-purple-300"><?php echo e($availableQty); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-3 flex items-center justify-between text-xs">
                            <span class="inline-flex items-center gap-1 px-2 py-1 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold">
                                ...
                                <?php echo e($publication->products->count()); ?> <?php echo e($publication->products->count() === 1 ? 'produto' : 'produtos'); ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($publication->error_message): ?>
                            <div class="mt-2 p-2 rounded-lg bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800">
                                <p class="text-[10px] text-red-600 dark:text-red-400 truncate" title="<?php echo e($publication->error_message); ?>">
                                    <i class="bi bi-exclamation-triangle"></i> <?php echo e(\Illuminate\Support\Str::limit($publication->error_message, 50)); ?>
                ...
                <div class="col-span-full">
                    <div class="rounded-2xl bg-slate-100 dark:bg-slate-900/50 border-2 border-dashed border-slate-300 dark:border-slate-700 p-12 text-center">
                        ...
                        <p class="text-sm text-slate-500 dark:text-slate-400 mb-4">
                            <!--[if BLOCK]><![endif]--><?php if($search || $statusFilter !== 'all' || $typeFilter !== 'all' || $syncFilter !== 'all'): ?>
                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div class="w-16 h-16 flex-shrink-0 rounded-xl overflow-hidden bg-slate-100 dark:bg-slate-800 shadow-md">
                                                <!--[if BLOCK]><![endif]--><?php if($mainImage): ?>
                                                    <img src="<?php echo e(is_array($mainImage) ? ($mainImage['url'] ?? $mainImage['secure_url'] ?? '') : $mainImage); ?>" 
                                            ...
                                            <div class="min-w-0 flex-1">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if($publication->ml_item_id): ?>
                                                    <p class="text-xs text-slate-500 dark:text-slate-400 font-mono">
                                                        <i class="bi bi-tag-fill"></i> <?php echo e($publication->ml_item_id); ?>
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex flex-col gap-1.5">
                                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg <?php echo e($statusConfig['color']); ?> text-xs font-semibold border w-fit">
                                                <i class="bi bi-<?php echo e($statusConfig['icon']); ?>"></i>
                                                <?php echo e(ucfirst($publication->status)); ?>

                                            </span>
                                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg <?php echo e($syncConfig['color']); ?> text-xs font-semibold border w-fit">
                                                <i class="bi bi-<?php echo e($syncConfig['icon']); ?>"></i>
                                                <?php echo e($publication->sync_status === 'synced' ? 'Sincronizado' : ($publication->sync_status === 'error' ? 'Erro' : 'Pendente')); ?>
                                    ...
                                    <td class="px-4 py-4">
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold <?php echo e($publication->publication_type === 'kit' ? 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300' : 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300'); ?>">
                                            <i class="bi bi-<?php echo e($publication->publication_type === 'kit' ? 'boxes' : 'box'); ?>"></i>
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex flex-wrap gap-1">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $publication->products->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded-md bg-slate-100 dark:bg-slate-800 text-xs text-slate-700 dark:text-slate-300" title="<?php echo e($product->name); ?>">
                                                    <i class="bi bi-box"></i>
                                                    <?php echo e(\Illuminate\Support\Str::limit($product->name, 20)); ?>

                                                </span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($publication->products->count() > 2): ?>
                                                <span class="inline-flex items-center px-2 py-1 rounded-md bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-bold">
                                                    +<?php echo e($publication->products->count() - 2); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($onlyOnMlItems->isNotEmpty()): ?>
        <div class="mt-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $onlyOnMlItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="rounded-2xl border-2 border-amber-200 dark:border-amber-800 bg-amber-50/50 dark:bg-amber-950/30 p-4 shadow-lg">
                        <!--[if BLOCK]><![endif]--><?php if(!empty($item['thumbnail'])): ?>
                            <img src="<?php echo e($item['thumbnail']); ?>" alt="" class="w-full h-40 object-contain rounded-xl bg-white dark:bg-slate-800 mb-3">
                        <?php else: ?>
                        ...
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <p class="font-semibold text-slate-900 dark:text-slate-100 text-sm line-clamp-2 mb-2" title="<?php echo e($item['title']); ?>"><?php echo e($item['title']); ?></p>
                        <p class="text-xs text-slate-500 dark:text-slate-400 font-mono mb-3"><?php echo e($item['id']); ?></p>
                        <div class="flex items-center gap-2">
                            <!--[if BLOCK]><![endif]--><?php if(!empty($item['permalink'])): ?>
                                <a href="<?php echo e($item['permalink']); ?>" target="_blank" rel="noopener"
                            ...
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <button wire:click="importFromMl('<?php echo e($item['id'] ?? ''); ?>')" wire:loading.attr="disabled"
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/mercadolivre/publications-list.blade.php ENDPATH**/ ?>