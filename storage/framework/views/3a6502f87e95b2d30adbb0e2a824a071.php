...
<div class="relative overflow-hidden bg-gradient-to-r from-white/80 via-blue-50/90 to-indigo-50/80 dark:from-slate-800/90 dark:via-blue-900/30 dark:to-indigo-900/30 backdrop-blur-xl border-b border-white/20 dark:border-slate-700/50 rounded-3xl shadow-2xl mb-6">
    ...
    <div class="relative px-4 py-3">
        ...
        <div class="flex items-center justify-between gap-6 mb-6">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="relative flex items-center justify-center w-16 h-16 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-2xl shadow-xl shadow-purple-500/25">
                    <i class="bi <?php echo e($showSteps ? 'bi-plus-circle' : 'bi-cart'); ?> text-white text-3xl"></i>
                ...
                <div class="space-y-2">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(!$showSteps): ?>
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-emerald-500/20 to-green-500/20 rounded-xl border border-emerald-200 dark:border-emerald-700">
                            ...
                            <span class="text-sm font-semibold text-emerald-700 dark:text-emerald-300"><?php echo e($totalSales); ?> vendas</span>
                        </div>
                        <!--[if BLOCK]><![endif]--><?php if($pendingSales > 0): ?>
                        <div class="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-xl border border-yellow-200 dark:border-yellow-700">
                            ...
                            <span class="text-sm font-semibold text-yellow-700 dark:text-yellow-300"><?php echo e($pendingSales); ?> pendentes</span>
                        </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <!--[if BLOCK]><![endif]--><?php if($todaySales > 0): ?>
                        <div class="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-xl border border-blue-200 dark:border-blue-700">
                            ...
                            <span class="text-sm font-semibold text-blue-700 dark:text-blue-300"><?php echo e($todaySales); ?> hoje</span>
                        </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!--[if BLOCK]><![endif]--><?php if($sales && !$showSteps): ?>
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2 px-3 py-2 bg-white/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-600 rounded-xl shadow-md">
                    ...
                    <div class="text-sm">
                        <span class="font-bold text-slate-800 dark:text-slate-200"><?php echo e($sales->total()); ?></span>
                        <span class="text-slate-600 dark:text-slate-400 ml-1"><?php echo e($sales->total() === 1 ? 'venda' : 'vendas'); ?></span>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-1 bg-white/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-600 rounded-xl p-1 shadow-md">
                    <!--[if BLOCK]><![endif]--><?php if($sales->currentPage() > 1): ?>
                    ...
                    <span class="px-2 text-xs font-medium text-slate-700 dark:text-slate-300">
                        <?php echo e($sales->currentPage()); ?> / <?php echo e($sales->lastPage()); ?>

                    </span>
                    <!--[if BLOCK]><![endif]--><?php if($sales->hasMorePages()): ?>
        ...
        <!-- Steppers Modernos -->
        <!--[if BLOCK]><![endif]--><?php if($showSteps && count($steps) > 0): ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex items-center">
                            <div class="flex items-center justify-center w-12 h-12 rounded-xl transition-all duration-300"
                                :class="currentStep === <?php echo e($stepNumber); ?> ? 'bg-gradient-to-br <?php echo e($step['gradient'] ?? 'from-indigo-500 to-purple-500'); ?> text-white shadow-lg shadow-indigo-500/30' : (currentStep > <?php echo e($stepNumber); ?> ? 'bg-green-500 text-white' : 'bg-gray-200 dark:bg-zinc-700 text-gray-600 dark:text-gray-400')">
                                <i class="bi <?php echo e($step['icon'] ?? 'bi-circle'); ?> text-xl" x-show="currentStep === <?php echo e($stepNumber); ?>"></i>
                                <i class="bi bi-check-lg text-xl" x-show="currentStep > <?php echo e($stepNumber); ?>"></i>
                            </div>
                            <div class="ml-4">
                                <div class="flex items-center">
                                    <p class="text-lg font-bold transition-colors duration-300"
                                        :class="currentStep === <?php echo e($stepNumber); ?> ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400'"><?php echo e($step['title']); ?></p>
                                    <i class="bi bi-check-circle-fill text-green-500 ml-2 text-lg" x-show="currentStep > <?php echo e($stepNumber); ?>"></i>
                                </div>
                                <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($step['description']); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="w-16 h-1 rounded-full transition-all duration-300"
                            :class="currentStep >= <?php echo e($stepNumber + 1); ?> ? 'bg-gradient-to-r <?php echo e($step['connector_gradient'] ?? 'from-indigo-500 to-purple-500'); ?>' : 'bg-gray-300 dark:bg-zinc-600'"></div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/components/sales-index-header.blade.php ENDPATH**/ ?>