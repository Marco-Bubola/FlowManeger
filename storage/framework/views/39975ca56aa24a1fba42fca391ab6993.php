<div class=" w-full " x-data="{
    ...
    hasActiveFilters: <?php echo e($search || $category || $tipo || $status_filtro || $preco_min || $preco_max || $estoque || $data_inicio || $data_fim ? 'true' : 'false'); ?>,
    fullHd: false,
    ultra: false,
    ...
    <?php if (isset($component)) { $__componentOriginal67a32d618c2c078e3596e4f9911d7f2e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67a32d618c2c078e3596e4f9911d7f2e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.products-header','data' => ['title' => 'Catálogo de Produtos','description' => '','totalProducts' => $products->total() ?? 0,'totalCategories' => $categories->count(),'showQuickActions' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('products-header'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Catálogo de Produtos','description' => '','total-products' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($products->total() ?? 0),'total-categories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($categories->count()),'show-quick-actions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
        ...
        <div class="space-y-4 w-full">
            ...
            <div class="flex items-center gap-4 w-full">
                ...
                <div class="flex items-center gap-3 pl-3 border-l-2 border-slate-200 dark:border-slate-600">
                    ...
                    <a href="<?php echo e(route('products.kit.create')); ?>"
                    ...
                    <a href="<?php echo e(route('products.upload')); ?>"
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <h3 class="text-sm font-bold text-slate-800 dark:text-slate-200">
                            <!--[if BLOCK]><![endif]--><?php if($products->total()): ?>
                                <?php echo e($products->total()); ?> <?php echo e($products->total() === 1 ? 'Produto' : 'Produtos'); ?>
                        ...
                        <?php if($products->total() > 0): ?>
                            <p class="text-xs text-slate-600 dark:text-slate-400">
                                <?php echo e($products->firstItem() ?? 0); ?> - <?php echo e($products->lastItem() ?? 0); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($products->hasPages()): ?>
                    <div class="flex items-center gap-1 bg-slate-100 dark:bg-slate-700 rounded-lg p-1">
                        <!--[if BLOCK]><![endif]--><?php if($products->currentPage() > 1): ?>
                            <a href="<?php echo e($products->url(1)); ?>" class="p-2 text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 hover:bg-white dark:hover:bg-slate-600 rounded transition-all duration-200" title="Primeira página">
                                <i class="bi bi-chevron-double-left text-sm"></i>
                            </a>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                        <!--[if BLOCK]><![endif]--><?php if($products->previousPageUrl()): ?>
                            <a href="<?php echo e($products->previousPageUrl()); ?>" class="p-2 text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 hover:bg-white dark:hover:bg-slate-600 rounded transition-all duration-200" title="Página anterior">
                                <i class="bi bi-chevron-left text-sm"></i>
                            </a>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                        <div class="flex items-center px-3 py-1">
                            <span class="text-sm font-medium text-slate-700 dark:text-slate-300"><?php echo e($products->currentPage()); ?> / <?php echo e($products->lastPage()); ?></span>
                        </div>

                        <!--[if BLOCK]><![endif]--><?php if($products->nextPageUrl()): ?>
                            <a href="<?php echo e($products->nextPageUrl()); ?>" class="p-2 text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 hover:bg-white dark:hover:bg-slate-600 rounded transition-all duration-200" title="Próxima página">
                                <i class="bi bi-chevron-right text-sm"></i>
                            </a>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                        <?php if($products->currentPage() < $products->lastPage()): ?>
                            <a href="<?php echo e($products->url($products->lastPage())); ?>" class="p-2 text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 hover:bg-white dark:hover:bg-slate-600 rounded transition-all duration-200" title="Última página">
...
<?php endif; ?>
<?php if (isset($__attributesOriginal67a32d618c2c078e3596e4f9911d7f2e)): ?>
<?php $attributes = $__attributesOriginal67a32d618c2c078e3596e4f9911d7f2e; ?>
<?php unset($__attributesOriginal67a32d618c2c078e3596e4f9911d7f2e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal67a32d618c2c078e3596e4f9911d7f2e)): ?>
<?php $component = $__componentOriginal67a32d618c2c078e3596e4f9911d7f2e; ?>
<?php unset($__componentOriginal67a32d618c2c078e3596e4f9911d7f2e); ?>
<?php endif; ?>



    <!-- Filtros Modernizados -->
    <?php if (isset($component)) { $__componentOriginala4035a8470936e80a99ca5d5d6204405 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala4035a8470936e80a99ca5d5d6204405 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.products-filters','data' => ['categories' => $categories,'search' => $search,'category' => $category,'tipo' => $tipo,'statusFiltro' => $status_filtro,'precoMin' => $preco_min,'precoMax' => $preco_max,'perPage' => $perPage,'perPageOptions' => $perPageOptions,'ordem' => $ordem,'estoqueFiltro' => $estoque ?? '','dataFiltro' => $data_inicio ?? '','totalProducts' => $products->total() ?? 0,'semEstoque' => $semEstoque]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('products-filters'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['categories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($categories),'search' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($search),'category' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($category),'tipo' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($tipo),'status_filtro' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($status_filtro),'preco_min' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($preco_min),'preco_max' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($preco_max),'per-page' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($perPage),'per-page-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($perPageOptions),'ordem' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($ordem),'estoque_filtro' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($estoque ?? ''),'data_filtro' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($data_inicio ?? ''),'total-products' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($products->total() ?? 0),'sem-estoque' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($semEstoque)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala4035a8470936e80a99ca5d5d6204405)): ?>
<?php $attributes = $__attributesOriginala4035a8470936e80a99ca5d5d6204405; ?>
<?php unset($__attributesOriginala4035a8470936e80a99ca5d5d6204405); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala4035a8470936e80a99ca5d5d6204405)): ?>
<?php $component = $__componentOriginala4035a8470936e80a99ca5d5d6204405; ?>
<?php unset($__componentOriginala4035a8470936e80a99ca5d5d6204405); ?>
<?php endif; ?>
    ...
    <?php else: ?>
        ...
        <form>
            <div class="products-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-5 ultrawind:grid-cols-8 gap-6"
                data-ultrawind="<?php echo e($ultraLayout ?? false ? 'true' : 'false'); ?>"
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!--[if BLOCK]><![endif]--><?php if($product->tipo === 'kit'): ?>
                        <!-- Kit Card no estilo produto simples -->
                        <div class="product-card-modern">
                            <!-- Botões flutuantes -->
                            <div class="btn-action-group">
                                <a href="<?php echo e(route('products.show', $product->product_code)); ?>"
                                    class="btn btn-secondary" title="Ver Detalhes">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="<?php echo e(route('products.kit.edit', $product)); ?>" class="btn btn-primary"
                                    title="Editar Kit">
                                ...
                                <button type="button" wire:click="confirmDelete(<?php echo e($product->id); ?>)"
                            ...
                            <div class="product-img-area">
                                ...
                                <span class="badge-quantity" title="Quantidade de Produtos no Kit" style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%);">
                                    <i class="bi bi-grid-3x3-gap"></i> <?php echo e($componentesCount); ?> <?php echo e($componentesCount === 1 ? 'item' : 'itens'); ?>

                                </span>

                                <!-- Ícone da categoria -->
                                <div class="category-icon-wrapper">
                                    <i class="<?php echo e($product->category->icone ?? 'bi bi-box-seam'); ?> category-icon"></i>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-2 mb-3 flex items-center gap-2 flex-wrap">
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-<?php echo e($product->status == 'ativo' ? 'green' : ($product->status == 'inativo' ? 'gray' : 'red')); ?>-100 text-<?php echo e($product->status == 'ativo' ? 'green' : ($product->status == 'inativo' ? 'gray' : 'red')); ?>-800 dark:bg-<?php echo e($product->status == 'ativo' ? 'green' : ($product->status == 'inativo' ? 'gray' : 'red')); ?>-900 dark:text-<?php echo e($product->status == 'ativo' ? 'green' : ($product->status == 'inativo' ? 'gray' : 'red')); ?>-200">
                                        <i class="bi bi-circle-fill mr-1"></i> <?php echo e(ucfirst($product->status)); ?>

                                    </span>

                                    <!-- Badge de novo -->
                                    <!--[if BLOCK]><![endif]--><?php if(\Carbon\Carbon::parse($product->created_at)->diffInDays(now()) <= 7): ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="product-card-modern">
                            ...
                            <!-- Área da imagem com badges -->
                            <div class="product-img-area">
                                <img src="<?php echo e(asset('storage/products/' . $product->image)); ?>" class="product-img"
                                    alt="<?php echo e($product->name); ?>">
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-2xl font-bold text-slate-800 dark:text-slate-200">
                                <?php echo e($products->where('status', 'ativo')->count()); ?></div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-2xl font-bold text-slate-800 dark:text-slate-200">
                                <?php echo e($products->where('stock_quantity', '<=', 5)->count()); ?></div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-2xl font-bold text-slate-800 dark:text-slate-200">
                                <?php echo e($products->whereNull('image')->count()); ?></div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-2xl font-bold text-slate-800 dark:text-slate-200">
                                R$ <?php echo e(number_format($products->sum('price_sale'), 0, ',', '.')); ?>
                    ...
                    <div class="flex flex-col lg:flex-row items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="text-sm text-slate-600 dark:text-slate-400">
                                📊 Exibindo
                                <span
                                    class="font-semibold text-slate-800 dark:text-slate-200"><?php echo e($products->firstItem() ?? 0); ?></span>
                                até
                                <span
                                    class="font-semibold text-slate-800 dark:text-slate-200"><?php echo e($products->lastItem() ?? 0); ?></span>
                                de
                                <span
                                    class="font-semibold text-slate-800 dark:text-slate-200"><?php echo e($products->total()); ?></span>
                                produtos
                            </div>
                            <div class="text-xs text-purple-500">
                                (<?php echo e($products->lastPage()); ?> <?php echo e($products->lastPage() === 1 ? 'página' : 'páginas'); ?>)
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <!-- Páginas -->
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $products->getUrlRange(max(1, $products->currentPage() - 2), min($products->lastPage(), $products->currentPage() + 2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!--[if BLOCK]><![endif]--><?php if($page == $products->currentPage()): ?>
                                    <span
                            ...
                            <!-- Última -->
                            <?php if($products->currentPage() < $products->lastPage()): ?>
                                <a href="<?php echo e($products->url($products->lastPage())); ?>"
                                    class="p-3 bg-white dark:bg-slate-700 hover:bg-slate-50 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md border border-slate-200 dark:border-slate-600"
                                    title="Última página">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(count($selectedProducts) > 0): ?>
                                    <div class="text-center">
                                        ...
                                        <p class="text-gray-700 dark:text-gray-300">
                                            ...
                                            <span
                                                class="font-bold text-red-600 dark:text-red-400"><?php echo e(count($selectedProducts)); ?>
                                ...
                                <?php else: ?>
                                    <div class="text-center">
                                        ...
                                        <p class="font-bold text-red-600 dark:text-red-400 text-lg mt-1">
                                            "<?php echo e($deletingProduct->name ?? ''); ?>"
                                        </p>
                                    </div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2787860565-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/products/products-index.blade.php ENDPATH**/ ?>