...
[$__name, $__params] = $__split('mercado-livre.product-publications-modal');

$__html = app('livewire')->mount($__name, $__params, 'lw-1882631775-0', $__slots ?? [], get_defined_vars());
            ...
            <div class="flex items-center justify-between gap-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-1.5 px-2.5 py-1 bg-gradient-to-r from-emerald-500/20 to-green-500/20 rounded-lg border border-emerald-200 dark:border-emerald-700">
                                ...
                                <span class="text-xs font-semibold text-emerald-700 dark:text-emerald-300"><?php echo e($this->totalProducts ?? 0); ?> produtos</span>
                            </div>
                            <div class="flex items-center gap-1.5 px-2.5 py-1 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-lg border border-blue-200 dark:border-blue-700">
                                ...
                                <span class="text-xs font-semibold text-blue-700 dark:text-blue-300"><?php echo e($this->publishedCount ?? 0); ?> publicados</span>
                            </div>
                            <!--[if BLOCK]><![endif]--><?php if(($this->pendingCount ?? 0) > 0): ?>
                            <div class="flex items-center gap-1.5 px-2.5 py-1 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-lg border border-yellow-200 dark:border-yellow-700">
                                ...
                                <span class="text-xs font-semibold text-yellow-700 dark:text-yellow-300"><?php echo e($this->pendingCount); ?> pendentes</span>
                            </div>
                ...
                <div class="flex items-center gap-3 flex-wrap justify-end">
                    ...
                    <div class="flex items-center gap-2 px-3 py-2 bg-white/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-600 rounded-xl shadow-md">
                        ...
                        <div class="text-sm">
                            <span class="font-bold text-slate-800 dark:text-slate-200"><?php echo e($products->total()); ?></span>
                            <span class="text-slate-600 dark:text-slate-400 ml-1"><?php echo e($products->total() === 1 ? 'produto' : 'produtos'); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-1.5">
                        <button wire:click="$set('statusFilter', 'all')"
                            class="px-3 py-1.5 rounded-lg text-xs font-semibold transition-all <?php echo e($statusFilter === 'all' ? 'bg-yellow-500 text-white shadow-lg shadow-yellow-500/30' : 'bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-600 hover:bg-slate-200 dark:hover:bg-slate-600'); ?>">
                            Todos
                        </button>
                        <button wire:click="$set('statusFilter', 'published')"
                            class="px-3 py-1.5 rounded-lg text-xs font-semibold transition-all <?php echo e($statusFilter === 'published' ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/30' : 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 border border-green-200 dark:border-green-700 hover:bg-green-200 dark:hover:bg-green-800'); ?>">
                            Publicados
                        </button>
                        <button wire:click="$set('statusFilter', 'unpublished')"
                            class="px-3 py-1.5 rounded-lg text-xs font-semibold transition-all <?php echo e($statusFilter === 'unpublished' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/30' : 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 border border-yellow-200 dark:border-yellow-700 hover:bg-yellow-200 dark:hover:bg-yellow-800'); ?>">
                            Pendentes
                        </button>
                    </div>
                    ...
                    <select wire:model.live="categoryFilter"
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category->id_category); ?>"><?php echo e($category->name); ?></option>
                    ...
                    <a href="<?php echo e(route('mercadolivre.products.publish.create')); ?>"
            ...
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="product-card-modern">
                    ...
                    <div class="product-img-area" style="height: 330px; position: relative; overflow: visible !important;">
                        <img src="<?php echo e($product->image_url); ?>" class="product-img" alt="<?php echo e($product->name); ?>">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($product->barcode): ?>
                            <span class="badge-product-code" title="Código de Barras (EAN)" style="top: 40px; left: 10px; padding: 4px 8px; font-size: 10px; background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
                                <i class="bi bi-upc"></i> <?php echo e($product->barcode); ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($product->mlPublications && $product->mlPublications->count() > 0): ?>
                            <button 
                                wire:click="$dispatch('openPublicationsModal', { productId: <?php echo e($product->id); ?> })" 
                                title="Ver Todas as Publicações (<?php echo e($product->mlPublications->count()); ?>)"
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($mlProduct): ?>
                            <?php
                            ...
                            <div class="absolute bottom-3 left-3 z-10">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-gradient-to-r <?php echo e($statusConfig['color']); ?> text-white shadow-lg border-2 border-white text-xs font-bold">
                        ...
                        <?php else: ?>
                            <!--[if BLOCK]><![endif]--><?php if($mlValidation['ready']): ?>
                                <div class="absolute bottom-3 left-3 z-10">
                        ...
                        <div class="absolute top-3 right-3 z-20 flex flex-col gap-2">
                            ...
                            <a href="<?php echo e(route('products.show', $product->product_code)); ?>" title="Ver Detalhes"
                            ...
                            <a href="<?php echo e(route('products.edit', $product->id)); ?>" title="Editar Produto"
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($mlProduct): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($mlProduct->status === 'active'): ?>
                                    <a href="<?php echo e(route('mercadolivre.products.publish', $product->id)); ?>" title="Nova Publicação"
                                    ...
                                    <button wire:click="syncProduct(<?php echo e($product->id); ?>)" wire:loading.attr="disabled" title="Sincronizar"
                                    ...
                                    <button wire:click="pauseProduct(<?php echo e($product->id); ?>)" wire:confirm="Pausar?" title="Pausar"
                                ...
                                <?php elseif($mlProduct->status === 'paused'): ?>
                                    <button wire:click="activateProduct(<?php echo e($product->id); ?>)" wire:loading.attr="disabled" title="Reativar"
                                    ...
                                    <button wire:click="checkMLStatus(<?php echo e($product->id); ?>)" title="Verificar Status"
                                            class="inline-flex items-center justify-center w-10 h-10 bg-blue-500 hover:bg-blue-600 text-white rounded-full shadow-lg transition-all">
                                        <i class="bi bi-search text-lg"></i>
                                    </button>
                                <?php elseif(in_array($mlProduct->status, ['closed', 'inactive'])): ?>
                                    <button wire:click="deleteLocalRecord(<?php echo e($product->id); ?>)" wire:confirm="Excluir?" title="Excluir Registro"
                                    ...
                                    <a href="<?php echo e(route('mercadolivre.products.publish', $product->id)); ?>" title="Publicar Novamente"
                                       class="inline-flex items-center justify-center w-10 h-10 bg-yellow-500 hover:bg-yellow-600 text-white rounded-full shadow-lg transition-all">
                                        <i class="bi bi-plus-circle text-lg"></i>
                                    </a>
                                <?php else: ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($firstPublication): ?>
                                    <a href="<?php echo e(route('mercadolivre.publications.edit', $firstPublication->id)); ?>" title="Editar Publicação"
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo e($mlValidation['ready'] ? route('mercadolivre.products.publish', $product->id) : '#'); ?>"
                                   <?php if(!$mlValidation['ready']): ?> onclick="event.preventDefault();" <?php endif; ?>
                                   title="<?php echo e($mlValidation['ready'] ? 'Publicar no ML' : 'Corrija as pendências'); ?>"
                                   class="inline-flex items-center justify-center w-10 h-10 rounded-full shadow-lg hover:shadow-xl transition-all <?php echo e($mlValidation['ready'] ? 'bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white animate-pulse' : 'bg-slate-400/90 dark:bg-slate-700/90 text-slate-600 dark:text-slate-400 cursor-not-allowed backdrop-blur-sm'); ?>">
                                    <i class="bi bi-<?php echo e($mlValidation['ready'] ? 'upload' : 'exclamation-circle'); ?> text-xl"></i>
                                </a>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                    </div>
                        ...
                        <div class="price-area mt-3">
                            <div class="flex flex-col gap-2">
                                ...
                                <span class="badge-price-sale" title="Preço de Venda">
                                    ...
                                    R$ <?php echo e(number_format($venda, 2, ',', '.')); ?>

                                </span>
                            </div>
                        </div>

                        <!--[if BLOCK]><![endif]--><?php if($mlProduct && $mlProduct->error_message): ?>
                            <div class="mt-3 p-2 rounded-lg bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800">
                                <p class="text-[10px] text-red-600 dark:text-red-400 truncate" title="<?php echo e($mlProduct->error_message); ?>">
                                    <i class="bi bi-exclamation-triangle"></i> <?php echo e(\Illuminate\Support\Str::limit($mlProduct->error_message, 60)); ?>
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/mercadolivre/product-integration.blade.php ENDPATH**/ ?>