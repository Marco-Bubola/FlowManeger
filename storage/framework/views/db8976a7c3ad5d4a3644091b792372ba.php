...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.sales-header','data' => ['title' => 'Venda #'.e($sale->id).'','description' => $descriptionHtml,'backRoute' => route('sales.index'),'currentStep' => 1,'steps' => []]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Venda #'.e($sale->id).'','description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($descriptionHtml),'back-route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('sales.index')),'current-step' => 1,'steps' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([])]); ?>
        ...
        <!-- Slot para botões de ação no header -->
         <?php $__env->slot('actions', null, []); ?> 
            ...
            <!--[if BLOCK]><![endif]--><?php if($sale->remaining_amount > 0): ?>
...
<?php endif; ?>
    ...
    <div class="container-fluid mx-auto px-6 py-8">
        <div class="mx-auto">
            ...
            <!-- Conteúdo das Abas -->
            <div class="tab-content <?php echo e($activeTab === 'resumo' ? 'resumo-tab' : ''); ?>">
                <!--[if BLOCK]><![endif]--><?php if($activeTab === 'resumo'): ?>
                            ...
                            <div class="xl:col-span-3 lg:col-span-3 space-y-4">
                                ...
                                <div class="bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-blue-900/20 dark:via-zinc-900/20 dark:to-indigo-900/20 rounded-2xl p-6 shadow-lg border border-blue-200 dark:border-blue-800 h-full">
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($sale->client && $sale->client->email): ?>
                                        <div>
                            ...
                            <div class="xl:col-span-4 lg:col-span-2 space-y-4">
                                ...
                                <div class="bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-purple-900/20 dark:via-zinc-900/20 dark:to-pink-900/20 rounded-2xl p-6 shadow-lg border border-purple-200 dark:border-purple-800">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="w-20 h-20 mx-auto mb-4 bg-<?php echo e($statusColor); ?>-500/10 rounded-full flex items-center justify-center">
                                            <i class="bi bi-<?php echo e($statusIcon); ?> text-<?php echo e($statusColor); ?>-600 dark:text-<?php echo e($statusColor); ?>-400 text-3xl"></i>
                                        </div>

                                        <h4 class="text-xl font-bold text-<?php echo e($statusColor); ?>-600 dark:text-<?php echo e($statusColor); ?>-400 mb-2">
                                        ...
                                        <div class="grid grid-cols-2 gap-4 text-center">
                                            ...
                                            <div class="bg-white/60 dark:bg-zinc-800/60 rounded-lg p-3">
                                                ...
                                                <p class="text-lg font-bold text-green-600 dark:text-green-400">
                                                    R$ <?php echo e(number_format($sale->total_paid, 2, ',', '.')); ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($sale->total_price > 0): ?>
                                            <?php $percentage = ($sale->total_paid / $sale->total_price) * 100; ?>
                                            <div class="mt-4">
                                                <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                                                    <div class="h-full bg-gradient-to-r from-<?php echo e($statusColor); ?>-500 to-<?php echo e($statusColor); ?>-600 rounded-full transition-all duration-1000"
                                                         style="width: <?php echo e($percentage); ?>%"></div>
                                                </div>
                                                <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mt-2">
                                                    <?php echo e(number_format($percentage, 1)); ?>% concluído
                                                </p>
                                            </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                ...
                                <div class="bg-gradient-to-br from-gray-50 via-white to-slate-50 dark:from-gray-900/20 dark:via-zinc-900/20 dark:to-slate-900/20 rounded-2xl p-4 shadow-lg border border-gray-200 dark:border-gray-800">
                                    ...
                                    <div class="grid grid-cols-2 gap-2 text-xs">
                                        <div class="text-center p-2 bg-white/60 dark:bg-zinc-800/60 rounded">
                                            ...
                                            <p class="font-bold text-blue-600 dark:text-blue-400"><?php echo e($sale->saleItems->count()); ?></p>
                                        </div>
                                        <div class="text-center p-2 bg-white/60 dark:bg-zinc-800/60 rounded">
                                            <p class="text-gray-500 dark:text-gray-400">Pagamentos</p>
                                            <p class="font-bold text-green-600 dark:text-green-400"><?php echo e($sale->payments->count()); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="xl:col-span-5 lg:col-span-3 space-y-4">
                                ...
                                <div class="bg-gradient-to-br from-emerald-50 via-white to-green-50 dark:from-emerald-900/20 dark:via-zinc-900/20 dark:to-green-900/20 rounded-2xl p-6 shadow-lg border border-emerald-200 dark:border-emerald-800 h-[48%]">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h3 class="text-lg font-bold text-gray-900 dark:text-white">
                                                    Produtos (<?php echo e($sale->saleItems->count()); ?>)
                                                </h3>
                                    ...
                                    <div class="space-y-3 max-h-40 overflow-y-auto">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sale->saleItems->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center justify-between p-3 bg-white/60 dark:bg-zinc-800/60 rounded-xl hover:bg-white/80 dark:hover:bg-zinc-800/80 transition-colors">
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <p class="text-xs text-gray-500 dark:text-gray-400">
                                                        <?php echo e($item->quantity); ?>x R$ <?php echo e(number_format($item->price_sale, 2, ',', '.')); ?>

                                                    </p>
                                                </div>
                                                <div class="text-right ml-2">
                                                    <p class="font-bold text-emerald-600 dark:text-emerald-400 text-sm">
                                                        R$ <?php echo e(number_format($item->price_sale * $item->quantity, 2, ',', '.')); ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($sale->saleItems->count() > 4): ?>
                                            <div class="text-center py-2">
                                                <span class="text-xs text-gray-500 dark:text-gray-400">
                                                    +<?php echo e($sale->saleItems->count() - 4); ?> produtos restantes
                                                </span>
                                            </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                ...
                                <div class="bg-gradient-to-br from-amber-50 via-white to-orange-50 dark:from-amber-900/20 dark:via-zinc-900/20 dark:to-orange-900/20 rounded-2xl p-6 shadow-lg border border-amber-200 dark:border-amber-800 h-[48%]">
                                    <div class="flex items-center justify-between mb-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h3 class="text-lg font-bold text-gray-900 dark:text-white">
                                                    Pagamentos (<?php echo e($sale->payments->count()); ?>)
                                                </h3>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($sale->payments->count() > 0): ?>
                                        <div class="space-y-3 max-h-40 overflow-y-auto">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sale->payments->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="flex items-center justify-between p-3 bg-white/60 dark:bg-zinc-800/60 rounded-xl hover:bg-white/80 dark:hover:bg-zinc-800/80 transition-colors">
                                                    <div class="flex items-center gap-3">
                                            ...
                                            <?php if($sale->payments->count() > 4): ?>
                                                <div class="text-center py-2">
                                                    <span class="text-xs text-gray-500 dark:text-gray-400">
                                                        +<?php echo e($sale->payments->count() - 4); ?> pagamentos restantes
                                                    </span>
                                                </div>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </div>
                ...
                <!--[if BLOCK]><![endif]--><?php if($activeTab === 'produtos'): ?>
                    <!-- Aba Produtos -->
                    <div class="space-y-8 animate-fade-in pb-12">
                        <?php if (isset($component)) { $__componentOriginal23e4bcf054cae9086eae3ab7ebe60992 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal23e4bcf054cae9086eae3ab7ebe60992 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.sale-products-grid','data' => ['sale' => $sale]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('sale-products-grid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['sale' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($sale)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal23e4bcf054cae9086eae3ab7ebe60992)): ?>
<?php $attributes = $__attributesOriginal23e4bcf054cae9086eae3ab7ebe60992; ?>
<?php unset($__attributesOriginal23e4bcf054cae9086eae3ab7ebe60992); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal23e4bcf054cae9086eae3ab7ebe60992)): ?>
<?php $component = $__componentOriginal23e4bcf054cae9086eae3ab7ebe60992; ?>
<?php unset($__componentOriginal23e4bcf054cae9086eae3ab7ebe60992); ?>
<?php endif; ?>
                    </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <!--[if BLOCK]><![endif]--><?php if($activeTab === 'pagamentos'): ?>
                    ...
                    <div class="space-y-8 animate-fade-in">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($sale->tipo_pagamento === 'parcelado' && $sale->parcelasVenda && $sale->parcelasVenda->count() > 0): ?>
                            <?php if (isset($component)) { $__componentOriginal31a60d11ad8179ff2e98b89dff221965 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal31a60d11ad8179ff2e98b89dff221965 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.installments-list','data' => ['parcelas' => $sale->parcelasVenda]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('installments-list'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['parcelas' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($sale->parcelasVenda)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal31a60d11ad8179ff2e98b89dff221965)): ?>
<?php $attributes = $__attributesOriginal31a60d11ad8179ff2e98b89dff221965; ?>
<?php unset($__attributesOriginal31a60d11ad8179ff2e98b89dff221965); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal31a60d11ad8179ff2e98b89dff221965)): ?>
<?php $component = $__componentOriginal31a60d11ad8179ff2e98b89dff221965; ?>
<?php unset($__componentOriginal31a60d11ad8179ff2e98b89dff221965); ?>
<?php endif; ?>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <?php if (isset($component)) { $__componentOriginal234bde993902ee181e5140dbdbfdcf8d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal234bde993902ee181e5140dbdbfdcf8d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.payments-list','data' => ['sale' => $sale]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('payments-list'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal234bde993902ee181e5140dbdbfdcf8d)): ?>
<?php $attributes = $__attributesOriginal234bde993902ee181e5140dbdbfdcf8d; ?>
<?php unset($__attributesOriginal234bde993902ee181e5140dbdbfdcf8d); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal234bde993902ee181e5140dbdbfdcf8d)): ?>
<?php $component = $__componentOriginal234bde993902ee181e5140dbdbfdcf8d; ?>
<?php unset($__componentOriginal234bde993902ee181e5140dbdbfdcf8d); ?>
<?php endif; ?>
                    </div>
                </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Parcela <?php echo e($selectedParcela?->numero_parcela ?? 0); ?></p>
                        </div>
                    </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="text-center p-4 bg-gradient-to-r from-gray-50 to-white dark:from-zinc-700 dark:to-zinc-800 rounded-2xl border border-gray-200 dark:border-zinc-600">
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">
                        R$ <?php echo e(number_format($selectedParcela?->valor ?? 0, 2, ',', '.')); ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showDiscountModal): ?>
    ...
    <?php if($sale->saleItems->count() > 0): ?>
        ...
        <div x-data="{ modalOpen: false }"
             x-show="modalOpen"
             x-on:show-modal-<?php echo e($item->id); ?>.window="modalOpen = true"
                    ...
                    <div class="relative z-10">
                            ...
                            <div class="bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 rounded-2xl p-4 border border-red-200/50 dark:border-red-700/50">
                                <div class="text-center">
                                    ...
                                    <div class="mt-3 flex items-center justify-center gap-4 text-sm text-gray-600 dark:text-gray-400">
                                        <span><i class="bi bi-hash mr-1"></i>Qtd: <?php echo e($item->quantity); ?></span>
                                        <span><i class="bi bi-currency-dollar mr-1"></i>R$ <?php echo e(number_format($item->price, 2, ',', '.')); ?></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="px-8 pb-8">
                            <div class="flex gap-4">
                                ...
                                <!-- Botão Remover -->
                                <button @click="modalOpen = false"
                                        wire:click="removeSaleItem(<?php echo e($item->id); ?>)"
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/sales/show-sale.blade.php ENDPATH**/ ?>