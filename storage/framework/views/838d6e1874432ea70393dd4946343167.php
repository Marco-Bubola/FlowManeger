    ...
    <div class="w-full">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
            ...
            <div class="lg:col-span-1 space-y-3">
                ...
                <div class="relative  rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-1"
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                    <?php echo e($currentMonthName ?? 'Carregando...'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between gap-2">
                            ...
                            <div class="flex items-center gap-2 flex-1">
                                <select wire:model.live="month"
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($m); ?>">
                                            <?php echo e(\Carbon\Carbon::create()->month($m)->locale('pt_BR')->isoFormat('MMM')); ?>
                                ...
                                <select wire:model.live="year"
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = range(now()->year - 5, now()->year + 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="px-5 pb-5">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(session('debug_info')): ?>
                            <div class="mb-3 p-2 bg-blue-100 border border-blue-300 rounded-xl text-xs text-blue-800">
                                <strong>Debug:</strong> <?php echo e(session('debug_info')); ?>

                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                        <!--[if BLOCK]><![endif]--><?php if(session('calendar_debug')): ?>
                            <div
                                class="mb-3 p-2 bg-yellow-100 border border-yellow-300 rounded-xl text-xs text-yellow-800">
                                <strong>Calendar:</strong> <?php echo e(session('calendar_debug')); ?>
                        ...
                        <div class="grid grid-cols-7">
                            <!--[if BLOCK]><![endif]--><?php if(isset($calendarDays) && is_array($calendarDays)): ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $calendarDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div wire:click="selectDate('<?php echo e($day['date']); ?>')"
                                        class="relative min-h-[42px] p-2 rounded-xl cursor-pointer transition-all duration-300 transform hover:scale-105 shadow-sm hover:shadow-md <?php echo e($day['isCurrentMonth'] ? 'bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg border-2 border-white/40 dark:border-gray-700/40 hover:border-blue-300 dark:hover:border-blue-600' : 'bg-gray-100/60 dark:bg-gray-700/60 backdrop-blur-sm border-2 border-gray-200/40 dark:border-gray-600/40'); ?> <?php echo e($day['isToday'] ? 'ring-2 ring-blue-500 shadow-lg shadow-blue-500/30 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30' : ''); ?> <?php echo e($selectedDate === $day['date'] ? 'ring-2 ring-green-500 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 shadow-lg shadow-green-500/30' : ''); ?>">
                                        <div
                                            class="text-sm font-bold <?php echo e($day['isCurrentMonth'] ? 'text-gray-900 dark:text-white' : 'text-gray-400 dark:text-gray-500'); ?> <?php echo e($day['isToday'] ? 'text-blue-700 dark:text-blue-400' : ''); ?> <?php echo e($selectedDate === $day['date'] ? 'text-green-700 dark:text-green-400' : ''); ?>">
                                            <?php echo e($day['day']); ?>

                                        </div>
                                        <!--[if BLOCK]><![endif]--><?php if(!empty($day['invoices'])): ?>
                            ...
                            <?php else: ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < 42; $i++): ?>
                                    <div
                ...
                <div class="relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-1"
                    ...
                    <div class="">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(count($categoriesChartData) > 0): ?>
                            <div>
                                <div id="apex-pie" class="w-full" style="height: 240px;"></div>
                                <script type="application/json" id="categories-data"><?php echo json_encode($categoriesChartData, 15, 512) ?></script>
                            </div>
                        <?php else: ?>
                            <div
            ...
            <div class="lg:col-span-3 space-y-3">
                ...
                <?php if (isset($component)) { $__componentOriginal9fb5bf3c9d04f3f0519f9ac268c15339 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9fb5bf3c9d04f3f0519f9ac268c15339 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.invoice-header','data' => ['totalTransactions' => $totalTransactions ?? 0,'totalExpenses' => $totalDespesas ?? 0,'average' => $totalTransactions > 0 ? $totalDespesas / $totalTransactions : 0,'bankId' => $bankId,'bank' => $bank,'selectedDate' => $selectedDate,'viewMode' => $viewMode,'invoicesCount' => count($invoices),'showQuickActions' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['total-transactions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($totalTransactions ?? 0),'total-expenses' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($totalDespesas ?? 0),'average' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($totalTransactions > 0 ? $totalDespesas / $totalTransactions : 0),'bank-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($bankId),'bank' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($bank),'selected-date' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($selectedDate),'view-mode' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($viewMode),'invoices-count' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(count($invoices)),'show-quick-actions' => true]); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal9fb5bf3c9d04f3f0519f9ac268c15339)): ?>
<?php $attributes = $__attributesOriginal9fb5bf3c9d04f3f0519f9ac268c15339; ?>
<?php unset($__attributesOriginal9fb5bf3c9d04f3f0519f9ac268c15339); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal9fb5bf3c9d04f3f0519f9ac268c15339)): ?>
<?php $component = $__componentOriginal9fb5bf3c9d04f3f0519f9ac268c15339; ?>
<?php unset($__componentOriginal9fb5bf3c9d04f3f0519f9ac268c15339); ?>
<?php endif; ?>

                <!-- Transactions List -->
                <div class="space-y-3">
                    <!-- Transactions Content -->
                    <!--[if BLOCK]><![endif]--><?php if($invoices && count($invoices) > 0): ?>
                        <!--[if BLOCK]><![endif]--><?php if($viewMode === 'cards'): ?>
                            <!-- Cards View -->
                            <div class="cards-scroll max-h-[50vh] lg:max-h-[60vh] overflow-auto pr-2">


                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $invoicesByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $cat = $group['category'] ?? [];
                                    ...
                                    <div class="category-group mb-8 transform transition-all duration-500 expanded"
                                        data-category-id="<?php echo e($catId); ?>">
                                        <!-- Card moderno com glassmorphism e cores da categoria -->
                                        <div class="relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-1"
                                            style="background: linear-gradient(135deg, <?php echo e($catColor); ?>15 0%, <?php echo e($catColor); ?>08 100%); border: 2px solid <?php echo e($catColor); ?>40;">

                                            <!-- Efeito de brilho decorativo -->
                                            <div class="absolute top-0 right-0 w-64 h-64 rounded-full blur-3xl opacity-20"
                                                style="background: <?php echo e($catColor); ?>;"></div>
                                            ...
                                            <div class="relative px-6 py-5 backdrop-blur-sm">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <div class="flex items-center gap-4 flex-1">
                                                        ...
                                                        <div class="relative group">
                                                            <div class="absolute inset-0 rounded-2xl blur-3xl opacity-30 group-hover:opacity-45 transition-opacity duration-300"
                                                                style="background: <?php echo e($catColor); ?>33;"></div>
                                                            <div class="relative w-16 h-16 rounded-2xl flex items-center justify-center transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 shadow-xl"
                                                                style="background: linear-gradient(135deg, <?php echo e($catColor); ?>33 0%, <?php echo e($catColor); ?>22 100%);">
                                                                <i
                                                                    class="<?php echo e($catIcon); ?> text-gray-900 text-2xl"></i>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="flex-1">
                                                            ...
                                                            <div class="flex items-center gap-4 text-sm">
                                                                <span
                                                                    ...
                                                                    style="background: linear-gradient(135deg, <?php echo e($catColor); ?>22 0%, <?php echo e($catColor); ?>11 100%);">
                                                                    ...
                                                                    <span
                                                                        class="text-sm font-medium"><?php echo e($catCount); ?>

                                                                        <?php echo e($catCount === 1 ? 'transação' : 'transações'); ?></span>
                                                                </span>
                                                                <span
                                                                    ...
                                                                    style="background: linear-gradient(135deg, <?php echo e($catColor); ?> 0%, <?php echo e($catColor); ?>CC 100%);">
                                                                    ...
                                                                    <span>R$
                                                                        <?php echo e(number_format($catTotal, 2, ',', '.')); ?></span>
                                                                </span>
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-category-id="<?php echo e($catId); ?>"
                                                        data-expanded="true"
                                                        style="--cat-color: <?php echo e($catColor); ?>;"
                                                        aria-label="Alternar visibilidade da categoria <?php echo e($catName); ?>">
                                                        ...
                                                        <!-- Toggle Switch -->
                                                         <div class="relative w-11 h-6 rounded-full transition-colors duration-300 toggle-switch"
                                                             style="background: linear-gradient(135deg, <?php echo e($catColor); ?> 0%, <?php echo e($catColor); ?>CC 100%); --cat-color: <?php echo e($catColor); ?>;">
                                            ...
                                            <div
                                                ...
                                                <div class="px-6 pb-6">
                                                    <div
                                                        ...
                                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $group['invoices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php
                                                                $value = abs(
                                                                    is_array($invoice)
                                                                        ? $invoice['value']
                                                            ...
                                                            <div class="invoice-card group relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden cursor-pointer"
                                                                ...
                                                                <div class="absolute top-0 left-0 right-0 h-1.5 transition-all duration-300 group-hover:h-2"
                                                                    style="background: linear-gradient(90deg, <?php echo e($catColor); ?> 0%, <?php echo e($catColor); ?>aa 100%);">
                                                                </div>
                                                                ...
                                                                <div class="p-4 pt-5 pb-3">
                                                                    <div
                                                                        ...
                                                                        <div class="flex-1 min-w-0">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <span
                                                                                    class="font-medium"><?php echo e($invoiceDate); ?></span>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="card-actions">
                                                                        <div
                                                                            ...
                                                                            <a href="<?php echo e(route('invoices.edit', ['invoiceId' => $invoiceId, 'return_month' => $month, 'return_year' => $year])); ?>"
                                                                            ...
                                                                            <a href="<?php echo e(route('invoices.copy', $invoiceId)); ?>"
                                                                            ...
                                                                            <button
                                                                                wire:click="confirmDelete(<?php echo e($invoiceId); ?>)"
                                                    ...
                                                    <div class="flex items-center space-x-4">
                                                        <div
                                                            ...
                                                            <!--[if BLOCK]><![endif]--><?php if(
                                                                ...
                                                                <i
                                                                    class="<?php echo e(is_array($invoice) ? $invoice['category']['icone'] ?? '' : $invoice->category->icone); ?> text-white text-lg"></i>
                                                            <?php else: ?>
                                                        ...
                                                        <div>
                                                            <p class="text-lg font-bold text-gray-900 dark:text-white">
                                                                <?php echo e(is_array($invoice) ? $invoice['description'] ?? '' : $invoice->description); ?>
                                                            ...
                                                            <div
                                                                ...
                                                                <span class="flex items-center">
                                                                    ...
                                                                    <?php echo e(\Carbon\Carbon::parse(is_array($invoice) ? $invoice['invoice_date'] : $invoice->invoice_date)->format('d/m/Y')); ?>

                                                                </span>
                                                                <!--[if BLOCK]><![endif]--><?php if(is_array($invoice) ? $invoice['category'] ?? null : $invoice->category): ?>
                                                                    <span
                                                                        class="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg text-xs font-medium">
                                                                        <?php echo e(is_array($invoice) ? $invoice['category']['name'] ?? '' : $invoice->category->name); ?>

                                                                    </span>
                                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                                <?php if(is_array($invoice) ? $invoice['installments'] ?? null : $invoice->installments): ?>
                                                                    <span
                                                                        class="px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 rounded-lg text-xs font-medium">
                                                                        <?php echo e(is_array($invoice) ? $invoice['installments'] ?? '' : $invoice->installments); ?>
                                                    ...
                                                    <div class="flex items-center space-x-4">
                                                        <div class="text-right">
                                                            <p class="text-xl font-black text-red-600">
                                                                - R$
                                                                <?php echo e(number_format(abs(is_array($invoice) ? $invoice['value'] : $invoice->value), 2, ',', '.')); ?>

                                                            </p>
                                                            <?php if(is_array($invoice) ? $invoice['client'] ?? null : $invoice->client): ?>
                                                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                                                    <?php echo e(is_array($invoice) ? $invoice['client']['name'] ?? '' : $invoice->client->name); ?>

                                                                </p>
                                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                        </div>

                                                        <!--[if BLOCK]><![endif]--><?php if($bankId): ?>
                                                            <div class="flex items-center space-x-2">
                                                                <a href="<?php echo e(route('invoices.edit', [
                                                                    'invoiceId' => is_array($invoice)
                                                                        ? $invoice['id_invoice'] ?? ($invoice['id'] ?? '')
                                                                        : $invoice->id_invoice ?? $invoice->id,
                                                                    'return_month' => $month,
                                                                ...
                                                                <a href="<?php echo e(route('invoices.copy', is_array($invoice) ? $invoice['id_invoice'] ?? ($invoice['id'] ?? '') : $invoice->id_invoice ?? $invoice->id)); ?>"
                                                                ...
                                                                <button
                                                                    wire:click="confirmDelete(<?php echo e(is_array($invoice) ? $invoice['id_invoice'] ?? ($invoice['id'] ?? '') : $invoice->id_invoice ?? $invoice->id); ?>)"
                        ...
                        <div
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($bankId): ?>
                                <div
                                    ...
                                    <a href="<?php echo e(route('invoices.create', ['bankId' => $bankId])); ?>"
                                    ...
                                    <a href="<?php echo e(route('invoices.upload', ['bankId' => $bankId])); ?>"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('keydown', function(e) {
                if (e.ctrlKey && e.key === 'n') {
                    e.preventDefault();
                    <!--[if BLOCK]><![endif]--><?php if($bankId): ?>
                        window.location.href = '<?php echo e(route('invoices.create', ['bankId' => $bankId])); ?>';
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                }

                // ESC para limpar filtro
                if (e.key === 'Escape' && window.Livewire.find('<?php echo e($_instance->getId()); ?>').selectedDate) {
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').clearDateFilter();
                }

                // Ctrl+R para recarregar dados
                if (e.ctrlKey && e.key === 'r') {
                    e.preventDefault();
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').loadData();
            ...
            try {
                window.__categoriesChartData = <?php echo json_encode($categoriesChartData ?? [], 15, 512) ?>;
            } catch (e) {
        ...
        function exportToCSV() {
            const data = <?php echo json_encode($invoices, 15, 512) ?>;
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/invoices/invoices-index.blade.php ENDPATH**/ ?>