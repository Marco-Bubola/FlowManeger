...
<div x-data="{ open: false }"
    ...
    <div x-show="open"
        ...
        <!--[if BLOCK]><![endif]--><?php if(isset($banks) && $banks->count() > 0): ?>
        <a href="<?php echo e(route('invoices.create', $banks->first()->id_bank)); ?>"
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/dashboard/partials/fab-menu.blade.php ENDPATH**/ ?>