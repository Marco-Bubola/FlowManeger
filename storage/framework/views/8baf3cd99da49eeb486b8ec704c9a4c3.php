    ...
    <div class="relative px-6 py-4">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 mb-4">
            <div class="flex items-center gap-4">
                <!-- Botão Voltar -->
                <a href="<?php echo e(route('banks.index')); ?>" class="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-white/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-all duration-150 mr-2 focus:outline-none focus:ring-2 focus:ring-purple-300 group shadow-none">
                    <i class="fas fa-arrow-left text-lg group-hover:-translate-x-1 transition-transform"></i>
                </a>
                <!-- Logo do Banco (se disponível) -->
                <!--[if BLOCK]><![endif]--><?php if($bank && $bank->caminho_icone): ?>
                    <?php
                        $cardColors = [
                    ...
                    <div class="relative flex items-center justify-center w-24 h-24 min-w-24 min-h-24 max-w-24 max-h-24 rounded-2xl shadow-xl overflow-visible">
                        <span class="absolute inset-0 rounded-2xl pointer-events-none border-4 border-transparent bg-clip-padding z-0 <?php echo e('bg-gradient-to-br ' . $gradient); ?>"></span>
                        <div class="relative w-[88px] h-[88px] bg-white/80 dark:bg-slate-800/80 rounded-2xl flex items-center justify-center overflow-hidden z-10">
                            ...
                            ?>
                            <img src="<?php echo e($isFullUrl ? $icone : asset('storage/' . ltrim($icone, '/'))); ?>"
                                 alt="<?php echo e($bank->name ?? 'Bank'); ?>"
            ...
            <div class="flex items-center gap-3 lg:gap-6 flex-wrap">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col items-end">
                        ...
                        <span class="text-2xl font-black text-emerald-600 dark:text-emerald-400">
                            R$ <?php echo e(number_format($average, 2, ',', '.')); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($showQuickActions && $bankId): ?>
                    <div class="flex flex-col gap-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($bankId && $invoicesCount > 0): ?>
                            <div role="tablist" aria-label="Modo de visualização" class="relative inline-flex rounded-2xl p-1.5 shadow-lg border-2 border-white/20 dark:border-slate-600/30 overflow-hidden backdrop-blur-sm" style="background: linear-gradient(135deg, rgba(148, 163, 184, 0.15) 0%, rgba(203, 213, 225, 0.1) 100%);">
                                ...
                                <button type="button" wire:click="setViewMode('cards')" role="tab"
                                    aria-pressed="<?php echo e($viewMode === 'cards' ? 'true' : 'false'); ?>"
                                    class="relative inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-black rounded-xl transition-all duration-300 overflow-hidden group <?php echo e($viewMode === 'cards' ? 'text-white' : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white'); ?>">
                                    ...
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <i class="fas fa-th-large text-base relative z-10 <?php echo e($viewMode === 'cards' ? 'animate-pulse' : 'group-hover:scale-110'); ?> transition-transform duration-300"></i>
                                ...
                                <button type="button" wire:click="setViewMode('list')" role="tab"
                                    ...
                                    class="relative inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-black rounded-xl transition-all duration-300 overflow-hidden group <?php echo e($viewMode === 'list' ? 'text-white' : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white'); ?>">
                                    <!--[if BLOCK]><![endif]--><?php if($viewMode === 'list'): ?>
                                        ...
                                        <div class="absolute -inset-0.5 bg-gradient-to-r from-indigo-500 to-pink-500 rounded-xl blur opacity-75 -z-10"></div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <i class="fas fa-list-ul text-base relative z-10 <?php echo e($viewMode === 'list' ? 'animate-pulse' : 'group-hover:scale-110'); ?> transition-transform duration-300"></i>
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/components/invoice-header.blade.php ENDPATH**/ ?>