            ...
            <div x-show="modalOpen"
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(!empty($availableConsortiums)): ?>
                            <div class="mb-4">
                                ...
                                <select wire:model.live="consortiumId"
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableConsortiums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cons): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cons['id']); ?>"><?php echo e($cons['name']); ?></option>
                        ...
                        <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(!empty($participants)): ?>
                                <div class="mb-4 space-y-2">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model.live="clientId"
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($option['client_id']); ?>"><?php echo e($option['label']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                        </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                <!--[if BLOCK]><![endif]--><?php if($consortiumId): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(!$consortiumId && !$clientId): ?>
                        ...
                        <div class="mt-4 p-4 bg-slate-100 dark:bg-slate-700/50 rounded-xl">
                            ...
                            <p class="text-sm text-slate-600 dark:text-slate-400">
                                <!--[if BLOCK]><![endif]--><?php switch($exportType):
                                    case ('pdf_full'): ?>
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/consortiums/export-consortium.blade.php ENDPATH**/ ?>