    ...
    <div class="w-full">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                ...
                <div class="relative rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-1"
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                    <?php echo e($monthName ?? 'Carregando...'); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="px-5 pb-5">
                        ...
                        <div class="grid grid-cols-7">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->calendarDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!--[if BLOCK]><![endif]--><?php if($day['day']): ?>
                                    <div wire:click="selectDate('<?php echo e($day['date']); ?>')"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($day['hasTransactions']): ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(isset($selectedDate) && $selectedDate): ?>
                            <div class="mt-4">
            ...
            <div class="lg:col-span-3 space-y-3">
                ...
                <?php if (isset($component)) { $__componentOriginalcd515c2942d678c22744132919a92e12 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcd515c2942d678c22744132919a92e12 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cashbook-header','data' => ['totalTransactions' => $transactionsCount ?? 0,'totalBalance' => $totals['balance'] ?? 0,'totalIncome' => $totals['income'] ?? 0,'totalExpense' => abs($totals['expense'] ?? 0),'showQuickActions' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cashbook-header'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['total-transactions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($transactionsCount ?? 0),'total-balance' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($totals['balance'] ?? 0),'total-income' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($totals['income'] ?? 0),'total-expense' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(abs($totals['expense'] ?? 0)),'show-quick-actions' => true]); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalcd515c2942d678c22744132919a92e12)): ?>
<?php $attributes = $__attributesOriginalcd515c2942d678c22744132919a92e12; ?>
<?php unset($__attributesOriginalcd515c2942d678c22744132919a92e12); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd515c2942d678c22744132919a92e12)): ?>
<?php $component = $__componentOriginalcd515c2942d678c22744132919a92e12; ?>
<?php unset($__componentOriginalcd515c2942d678c22744132919a92e12); ?>
<?php endif; ?>
                ...
                <div class="space-y-3">
                    ...
                    <div class="space-y-3 max-h-[calc(100vh-200px)] overflow-y-auto cards-scroll">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $transactionsByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $categoryGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <div class="category-group mb-8 transform transition-all duration-500 expanded"
                                data-category-id="<?php echo e($index); ?>">
                                    ...
                                    <div class="relative px-6 py-5 backdrop-blur-sm">
                                        <div class="flex items-center justify-between gap-6">
                                            ...
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div class="relative group">
                                                    ...
                                                    <div class="relative w-16 h-16 rounded-2xl flex items-center justify-center transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 shadow-xl"
                                                        ...
                                                        <i class="<?php echo e($catIcon); ?> text-gray-900 text-2xl"></i>
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        ...
                                                        <span class="text-sm font-medium"><?php echo e($catCount); ?>
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-lg font-black text-green-600 dark:text-green-400">
                                                        R$ <?php echo e(number_format($catIncome, 2, ',', '.')); ?>
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-lg font-black text-red-600 dark:text-red-400">
                                                        R$ <?php echo e(number_format($catExpense, 2, ',', '.')); ?>
                                            ...
                                            <div class="flex items-center gap-3">
                                                <div class="relative group">
                                                    <div class="absolute inset-0 rounded-xl blur-2xl opacity-40 group-hover:opacity-60 transition-opacity"
                                                        style="background: linear-gradient(135deg, <?php echo e($catBalance >= 0 ? '#3b82f6 0%, #6366f1' : '#f97316 0%, #ea580c'); ?> 100%);">
                                                    </div>
                                                    <div class="relative w-12 h-12 rounded-xl flex items-center justify-center shadow-lg"
                                                        style="background: linear-gradient(135deg, <?php echo e($catBalance >= 0 ? 'rgba(59, 130, 246, 0.2) 0%, rgba(99, 102, 241, 0.15)' : 'rgba(249, 115, 22, 0.2) 0%, rgba(234, 88, 12, 0.15)'); ?> 100%);">
                                                        <svg class="w-5 h-5 <?php echo e($catBalance >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-orange-600 dark:text-orange-400'); ?>"
                                                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
                                                ...
                                                <div>
                                                    <p
                                                        ...
                                                        Saldo</p>
                                                    <p
                                                        class="text-lg font-black <?php echo e($catBalance >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-orange-600 dark:text-orange-400'); ?>">
                                                        R$ <?php echo e(number_format($catBalance, 2, ',', '.')); ?>
                                            ...
                                            <button type="button"
                                                ...
                                                data-category-id="<?php echo e($index); ?>" data-expanded="true"
                                    ...
                                    <div
                                        ...
                                        <div class="px-6 pb-6">
                                            <div
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categoryGroup['transactions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="p-4 pt-5 pb-3">
                                                            <div class="flex items-start justify-between gap-3 mb-3">
                                                                ...
                                                                <span
                                                                    class="px-2.5 py-1 text-xs font-bold rounded-lg shadow-md <?php echo e($typeId == 1 ? 'bg-gradient-to-br from-green-500 to-emerald-600 text-white' : 'bg-gradient-to-br from-red-500 to-rose-600 text-white'); ?>">
                                                                    <i
                                                                        class="fas <?php echo e($typeId == 1 ? 'fa-arrow-up' : 'fa-arrow-down'); ?> mr-1"></i>
                                                                    <?php echo e($typeId == 1 ? 'Receita' : 'Despesa'); ?>
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    class="text-2xl font-black <?php echo e($typeId == 1 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                                                    <?php echo e($typeId == 1 ? '+' : '-'); ?> R$
                                                            ...
                                                            <!-- Cliente (se houver) -->
                                                            <!--[if BLOCK]><![endif]--><?php if($clientName): ?>
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="font-medium"><?php echo e($clientName); ?></span>
                                                                </div>
                                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                                                            <!-- Actions -->
                                                            <div class="card-actions">
                                                                <!--[if BLOCK]><![endif]--><?php if(isset($transaction['id'])): ?>
                                                                <div
                                                                    class="flex items-center justify-center gap-2 pt-3 border-t border-gray-100 dark:border-gray-700">
                                                                    <a href="<?php echo e(route('cashbook.edit', ['cashbook' => $transaction['id'], 'return_month' => $month, 'return_year' => $year])); ?>"
                ...
                <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="relative z-10 p-8">
                        <div class="text-center">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($deletingTransaction): ?>
                                <p
                                    class="text-sm text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700/50 rounded-xl p-3 mb-6">
                                    <strong>#<?php echo e($deletingTransaction->id); ?></strong> —
                                    <?php echo e($deletingTransaction->description ?? 'Sem descrição'); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            ...
            initOrUpdateCashbookPieChart(<?php echo json_encode($categoriesChartData, 15, 512) ?>);
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/cashbook/cashbook-index.blade.php ENDPATH**/ ?>