<div class="w-full h-full flex flex-col">
            ...
            <div class="flex items-center justify-between px-4 py-2 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm font-bold text-purple-700 dark:text-purple-400">
                        <?php echo e(count($products)); ?> produto(s) no kit
                    </span>
                </div>
                <div class="text-sm text-purple-600 dark:text-purple-400">
                    Disponível: <span class="font-black"><?php echo e($this->getAvailableQuantity()); ?></span>
                </div>
            </div>
    ...
    <div class="flex-1 overflow-y-auto mt-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 pr-2">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $searchResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="product-card-modern <?php echo e($isSelected ? 'selected' : ''); ?>"
                         wire:click="addProduct(<?php echo e($result['id']); ?>)"
                         wire:key="product-selector-<?php echo e($result['id']); ?>">
                        ...
                        <div class="product-img-area">
                            <img src="<?php echo e($result['image_url']); ?>"
                                 alt="<?php echo e($result['name']); ?>"
                                 class="product-img">

                            <!--[if BLOCK]><![endif]--><?php if($result['stock_quantity'] <= 5): ?>
                            ...
                            <span class="badge-product-code">
                                <i class="bi bi-upc-scan"></i> <?php echo e($result['product_code']); ?>

                            </span>

                            <!-- Quantidade em estoque -->
                            <span class="badge-quantity">
                                <i class="bi bi-stack"></i> <?php echo e($result['stock_quantity']); ?>
                        ...
                        <!-- Conteúdo do card -->
                        <div class="card-body">
                            <div class="product-title" title="<?php echo e($result['name']); ?>">
                                <?php echo e(ucwords($result['name'])); ?>
                            ...
                            <div class="price-area">
                                <span class="badge-price" title="Preço">
                                    ...
                                    <?php echo e(number_format($result['price'], 2, ',', '.')); ?>
        ...
        <?php elseif(strlen($searchTerm) > 0): ?>
            ...
            <div class="flex flex-col items-center justify-center h-full py-12">
                ...
                <h3 class="text-xl font-semibold text-slate-800 dark:text-slate-200 mb-2">
                    Nenhum produto encontrado para "<?php echo e($searchTerm); ?>"
                </h3>
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/mercadolivre/components/product-selector.blade.php ENDPATH**/ ?>