...
<head>
    ...
    <title>Venda #<?php echo e($sale->id); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="info-section">
            ...
            <div class="info-box">
                <h3>CLIENTE</h3>
                <p><?php echo e($sale->client->name); ?></p>
                <?php if($sale->client->email): ?>
                <p class="small">Email: <?php echo e($sale->client->email); ?></p>
                <?php endif; ?>
                <?php if($sale->client->phone): ?>
                <p class="small">Fone: <?php echo e($sale->client->phone); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="info-box">
                ...
                <p>
                    <span class="status <?php echo e($sale->status); ?>"><?php echo e(ucfirst($sale->status)); ?></span>
                </p>
                <p class="small">
                    <?php echo e($sale->tipo_pagamento === 'a_vista' ? 'A Vista' : 'Parcelado'); ?>

                    <?php if($sale->tipo_pagamento === 'parcelado'): ?>
                    (<?php echo e($sale->parcelas); ?>x de R$ <?php echo e(number_format($sale->total_price / $sale->parcelas, 2, ',', '.')); ?>)
                    <?php endif; ?>
                </p>
                <p class="small">Criada em <?php echo e($sale->created_at->format('d/m/Y H:i')); ?></p>
            </div>
        </div>
                ...
                <div class="products-row">
                    ...
                    <div class="product-card">
                        <div class="product-image-container">
                            <?php if($item->product->image && $item->product->image !== 'product-placeholder.png'): ?>
                            <?php
                            ...
                            ?>
                            <?php if(isset($hasValidImage) && $hasValidImage): ?>
                            <img src="data:<?php echo e($mimeType); ?>;base64,<?php echo e($imageData); ?>"
                            ...
                            <div class="product-placeholder" style="display: flex; flex-direction: column; align-items: center; justify-content: center; font-size: 24px; color: #9575cd;">
                                ...
                                <div style="font-size: 12px; text-align: center; line-height: 1.2; max-width: 120px; word-wrap: break-word;"><?php echo e(Str::limit($item->product->name, 25)); ?></div>
                            </div>
                            <?php endif; ?>
                            <?php else: ?>
                            <div class="product-placeholder" style="display: flex; flex-direction: column; align-items: center; justify-content: center; font-size: 24px; color: #9575cd;">
                            ...
                            <?php endif; ?>                            <div class="product-code-badge">
                                #<?php echo e($item->product->product_code ?? 'N/A'); ?>

                            </div>
                        </div>

                        <div class="product-info">
                            <h3 class="product-name"><?php echo e($item->product->name); ?></h3>
                            ...
                            <div class="product-details" style="display: flex; gap: 6px; align-items: center; justify-center: center;">
                                <div class="product-quantity" style="margin-bottom: 0; width: auto;">
                                    Qtd: <?php echo e($item->quantity); ?>

                                </div>
                                <div class="product-price" style="margin-bottom: 0; width: auto;">
                                    R$ <?php echo e(number_format($item->price_sale, 2, ',', '.')); ?>

                                </div>
                            </div>

                            <div class="product-total">
                                Total: R$ <?php echo e(number_format($item->quantity * $item->price_sale, 2, ',', '.')); ?>
    ...
    <div class="total-section">
        <div class="total-row">
            ...
            <span class="total-value">R$ <?php echo e(number_format($sale->total_price, 2, ',', '.')); ?></span>
        </div>

        <?php if($sale->tipo_pagamento === 'parcelado' && $sale->parcelas > 1): ?>
        <div class="total-row">
            <span class="total-label">Forma de Pagamento:</span>
            <span class="total-value"><?php echo e($sale->parcelas); ?>x de R$ <?php echo e(number_format($sale->total_price / $sale->parcelas, 2, ',', '.')); ?></span>
        </div>
        <?php endif; ?>
        ...
        <div class="total-row">
            ...
            <span class="total-value" style="color: #10b981;">R$ <?php echo e(number_format($sale->total_paid, 2, ',', '.')); ?></span>
        </div>
        <?php endif; ?>
        ...
        <div class="total-row">
            ...
            <span class="total-value" style="color: #dc2626;">R$ <?php echo e(number_format($sale->remaining_amount, 2, ',', '.')); ?></span>
        </div>
        <?php endif; ?>
    ...
    <div class="payments-section">
        ...
        <div class="payment-card">
            <div class="payment-header">
                ...
                <span class="payment-method"><?php echo e(ucfirst(str_replace('_', ' ', $payment->payment_method))); ?></span>
            </div>
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/pdfs/sale.blade.php ENDPATH**/ ?>