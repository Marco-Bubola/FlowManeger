...
<div>
    <!--[if BLOCK]><![endif]--><?php if($show && $achievement): ?>
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                    <div class="flex items-start gap-3">
                        <div class="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-br from-white/20 to-white/10 flex items-center justify-center">
                            <i class="<?php echo e($achievement['icon'] ?? 'bi bi-star-fill'); ?> text-2xl"></i>
                        </div>
                        <div class="flex-1">
                            <h5 class="font-bold text-base mb-1 flex items-center gap-2">
                                <?php echo e($achievement['name'] ?? 'Nova Conquista'); ?>

                                <span class="px-2 py-0.5 text-xs rounded-full capitalize" style="background: <?php echo e($achievement['rarity_color'] ?? '#CD7F32'); ?>">
                                    <?php echo e($achievement['rarity'] ?? 'bronze'); ?>

                                </span>
                            </h5>
                            <p class="text-sm text-purple-100 mb-2"><?php echo e($achievement['description'] ?? ''); ?></p>
                            <div class="flex items-center gap-2 text-xs">
                                <span class="px-2 py-1 bg-yellow-500/30 rounded-full font-semibold">
                                    <i class="bi bi-star-fill mr-1"></i>+<?php echo e($achievement['points'] ?? 0); ?> pontos
                                </span>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/components/achievement-notifier.blade.php ENDPATH**/ ?>