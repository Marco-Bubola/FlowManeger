                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-6 text-lg">
                        <div class="flex items-center gap-2 px-4 py-2 bg-white/60 dark:bg-slate-700/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-slate-600/50">
                            ...
                            <span class="font-semibold text-slate-700 dark:text-slate-300"><?php echo e($totalProducts); ?></span>
                        ...
                        <div class="flex items-center gap-2 px-4 py-2 bg-white/60 dark:bg-slate-700/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-slate-600/50">
                            ...
                            <span class="font-semibold text-slate-700 dark:text-slate-300"><?php echo e($totalCategories); ?></span>
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/components/products-header.blade.php ENDPATH**/ ?>