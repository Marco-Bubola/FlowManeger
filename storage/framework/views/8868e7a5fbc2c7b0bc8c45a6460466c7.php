...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['index', 'payment' => [], 'showRemove' => false]));
...
foreach (array_filter((['index', 'payment' => [], 'showRemove' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="bg-gradient-to-br from-white to-gray-50 dark:from-zinc-800 dark:to-zinc-900 p-6 border border-gray-200 dark:border-zinc-700 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 relative group hover-lift">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <!--[if BLOCK]><![endif]--><?php if($showRemove): ?>
            <button type="button"
                    wire:click="removePaymentRow(<?php echo e($index); ?>)"
    ...
    <div class="space-y-4">
        ...
        <div class="space-y-2">
            ...
            <div class="relative">
                ...
                <input type="text"
                       id="payment-<?php echo e($index); ?>"
                       x-data="{
                           displayValue: '<?php echo e(isset($payment['amount_paid']) && $payment['amount_paid'] ? number_format((float)$payment['amount_paid'], 2, ',', '.') : '0,00'); ?>',
                       ...
                       x-on:input="
                           ...
                           window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('payments.<?php echo e($index); ?>.amount_paid', numericValue);
                       "
            ...
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ["payments.{$index}.amount_paid"];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="space-y-2">
            ...
            <select wire:model="payments.<?php echo e($index); ?>.payment_method"
        ...
        <div class="space-y-2">
            ...
            <input type="date"
                   wire:model="payments.<?php echo e($index); ?>.payment_date"
        ...
        <!-- Preview do Valor -->
        <!--[if BLOCK]><![endif]--><?php if(isset($payment['amount_paid']) && is_numeric($payment['amount_paid']) && $payment['amount_paid'] > 0): ?>
            <div class="mt-4 p-3 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl border border-green-200 dark:border-green-800">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-lg font-bold text-green-600 dark:text-green-400">
                        R$ <?php echo e(number_format((float)$payment['amount_paid'], 2, ',', '.')); ?>
        ...
        <!-- Nota para desconto -->
        <!--[if BLOCK]><![endif]--><?php if(isset($payment['payment_method']) && $payment['payment_method'] === 'desconto'): ?>
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/components/payment-form-card.blade.php ENDPATH**/ ?>