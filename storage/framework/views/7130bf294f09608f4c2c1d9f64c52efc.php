...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.category-header','data' => ['title' => 'Categorias','description' => 'Organize e gerencie suas categorias com eficiência','totalCategories' => $productCategories->count() + $transactionCategories->count(),'productCategories' => $productCategories->count(),'transactionCategories' => $transactionCategories->count(),'activeTab' => $activeTab,'showQuickActions' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Categorias','description' => 'Organize e gerencie suas categorias com eficiência','total-categories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($productCategories->count() + $transactionCategories->count()),'product-categories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($productCategories->count()),'transaction-categories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($transactionCategories->count()),'active-tab' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($activeTab),'show-quick-actions' => true]); ?>
...
<?php endif; ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <?php if (isset($component)) { $__componentOriginal82380e8b2e1e5f2d8e5720cb4b9b013b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal82380e8b2e1e5f2d8e5720cb4b9b013b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.category-stats-card','data' => ['title' => 'Categorias de Produtos','value' => $productCategories->count(),'icon' => 'fa-box','color' => 'blue','subtitle' => round(($productCategories->count() / max(($productCategories->count() + $transactionCategories->count()), 1)) * 100) . '% do total']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('category-stats-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Categorias de Produtos','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($productCategories->count()),'icon' => 'fa-box','color' => 'blue','subtitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(round(($productCategories->count() / max(($productCategories->count() + $transactionCategories->count()), 1)) * 100) . '% do total')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal82380e8b2e1e5f2d8e5720cb4b9b013b)): ?>
<?php $attributes = $__attributesOriginal82380e8b2e1e5f2d8e5720cb4b9b013b; ?>
<?php unset($__attributesOriginal82380e8b2e1e5f2d8e5720cb4b9b013b); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal82380e8b2e1e5f2d8e5720cb4b9b013b)): ?>
<?php $component = $__componentOriginal82380e8b2e1e5f2d8e5720cb4b9b013b; ?>
<?php unset($__componentOriginal82380e8b2e1e5f2d8e5720cb4b9b013b); ?>
<?php endif; ?>

        <?php if (isset($component)) { $__componentOriginal82380e8b2e1e5f2d8e5720cb4b9b013b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal82380e8b2e1e5f2d8e5720cb4b9b013b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.category-stats-card','data' => ['title' => 'Categorias de Transações','value' => $transactionCategories->count(),'icon' => 'fa-exchange-alt','color' => 'emerald','subtitle' => round(($transactionCategories->count() / max(($productCategories->count() + $transactionCategories->count()), 1)) * 100) . '% do total']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('category-stats-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Categorias de Transações','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($transactionCategories->count()),'icon' => 'fa-exchange-alt','color' => 'emerald','subtitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(round(($transactionCategories->count() / max(($productCategories->count() + $transactionCategories->count()), 1)) * 100) . '% do total')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal82380e8b2e1e5f2d8e5720cb4b9b013b)): ?>
<?php $attributes = $__attributesOriginal82380e8b2e1e5f2d8e5720cb4b9b013b; ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginal82380e8b2e1e5f2d8e5720cb4b9b013b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal82380e8b2e1e5f2d8e5720cb4b9b013b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.category-stats-card','data' => ['title' => 'Categorias Ativas','value' => $categories->where('is_active', 1)->count(),'icon' => 'fa-check-circle','color' => 'orange','subtitle' => $categories->where('is_active', 0)->count() . ' inativas']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('category-stats-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Categorias Ativas','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($categories->where('is_active', 1)->count()),'icon' => 'fa-check-circle','color' => 'orange','subtitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($categories->where('is_active', 0)->count() . ' inativas')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal82380e8b2e1e5f2d8e5720cb4b9b013b)): ?>
<?php $attributes = $__attributesOriginal82380e8b2e1e5f2d8e5720cb4b9b013b; ?>
...
<?php endif; ?>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden mb-4">
        <div class="flex border-b border-slate-200 dark:border-slate-700">
            ...
            <button wire:click="setActiveTab('products')"
                    class="flex-1 flex items-center justify-center px-6 py-3 text-sm font-semibold transition-all duration-300 <?php echo e($activeTab === 'products' ? 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-lg' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700'); ?>">
                <div class="flex items-center gap-2">
                    <i class="fas fa-box"></i>
                    <span>Produtos</span>
                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($activeTab === 'products' ? 'bg-white/20 text-white' : 'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200'); ?>">
                        <?php echo e($productCategories->count()); ?>
            ...
            <button wire:click="setActiveTab('transactions')"
                    class="flex-1 flex items-center justify-center px-6 py-3 text-sm font-semibold transition-all duration-300 <?php echo e($activeTab === 'transactions' ? 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700'); ?>">
                <div class="flex items-center gap-2">
                    <i class="fas fa-exchange-alt"></i>
                    <span>Transações</span>
                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($activeTab === 'transactions' ? 'bg-white/20 text-white' : 'bg-emerald-100 dark:bg-emerald-900 text-emerald-800 dark:text-emerald-200'); ?>">
                        <?php echo e($transactionCategories->count()); ?>
            ...
            <button wire:click="setActiveTab('all')"
                    class="flex-1 flex items-center justify-center px-6 py-3 text-sm font-semibold transition-all duration-300 <?php echo e($activeTab === 'all' ? 'bg-gradient-to-r from-purple-500 to-pink-600 text-white shadow-lg' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700'); ?>">
                <div class="flex items-center gap-2">
                    <i class="fas fa-list"></i>
                    <span>Todas</span>
                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($activeTab === 'all' ? 'bg-white/20 text-white' : 'bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200'); ?>">
                        <?php echo e($productCategories->count() + $transactionCategories->count()); ?>
            ...
            <button wire:click="setActiveTab('tips')"
                    class="flex-1 flex items-center justify-center px-6 py-3 text-sm font-semibold transition-all duration-300 <?php echo e($activeTab === 'tips' ? 'bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-lg' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700'); ?>">
                <div class="flex items-center gap-2">
    ...
    <!--[if BLOCK]><![endif]--><?php if($activeTab === 'all'): ?>
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden mb-4">
        <div class="bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-700 dark:to-slate-800 px-6 py-4 border-b border-slate-200 dark:border-slate-700 cursor-pointer"
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-sm text-slate-500 dark:text-slate-400">(<?php echo e($categories->total()); ?> resultados)</span>
                </div>
                <div class="flex items-center">
                    <i class="fas fa-chevron-<?php echo e($showFilters ? 'up' : 'down'); ?> text-slate-400 dark:text-slate-500 transition-transform duration-200"></i>
                </div>
            </div>
        </div>

        <div class="transition-all duration-300 ease-in-out <?php echo e($showFilters ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'); ?>">
            <div class="p-6">
            ...
            <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-white bg-opacity-20 dark:bg-slate-800 dark:bg-opacity-50 rounded-xl px-3 py-2">
                        <span class="text-white dark:text-slate-100 font-semibold text-sm"><?php echo e($paginatedProductCategories->total()); ?> categorias</span>
                    </div>
                </div>
            </div>

            <!--[if BLOCK]><![endif]--><?php if($paginatedProductCategories->count() > 0): ?>
                <div class="p-6">
                    <!-- Grid 2 por linha -->
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4" wire:sortable="updateProductOrder">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $paginatedProductCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.category-card','data' => ['category' => $category,'type' => 'product']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['category' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($category),'type' => 'product']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <div class="mt-6">
                        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4">
                            <?php echo e($paginatedProductCategories->links()); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($activeTab === 'transactions'): ?>
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="bg-white bg-opacity-20 dark:bg-gray-800 dark:bg-opacity-50 rounded-xl px-4 py-2">
                            <span class="text-white dark:text-gray-100 font-semibold"><?php echo e($paginatedTransactionCategories->total()); ?> categorias</span>
                        </div>
            ...
            <!--[if BLOCK]><![endif]--><?php if($paginatedTransactionCategories->count() > 0): ?>
                <div class="p-8">
                   <!-- Grid 2 por linha -->
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" wire:sortable="updateTransactionOrder">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $paginatedTransactionCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div wire:sortable.item="<?php echo e($category->id_category); ?>" wire:key="transaction-<?php echo e($category->id_category); ?>"
                                ...
                                <div class="p-6">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center flex-1">
                                            ...
                                            <div class="relative mr-4">
                                                <div class="w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-lg transform group-hover:scale-110 transition-transform duration-300"
                                                     style="background: linear-gradient(135deg, <?php echo e($category->hexcolor_category ?? '#10B981'); ?>, <?php echo e($category->hexcolor_category ?? '#10B981'); ?>dd)">
                                                    <!--[if BLOCK]><![endif]--><?php if($category->icone): ?>
                                                        <i class="<?php echo e($category->icone); ?>" style="font-size: 1.8rem;"></i>
                                                    <?php else: ?>
                                                        <span class="text-2xl">
                                                            <!--[if BLOCK]><![endif]--><?php switch($category->name):
                                                                case ('Nubank'): ?>
                                                                    🏛️
                                                                    <?php break; ?>
                                                                <?php case ('Salario'): ?>
                                                                    💼
                                                                    <?php break; ?>
                                                                <?php case ('Alimentação'): ?>
                                                                    🍴
                                                                    <?php break; ?>
                                                                <?php case ('Transporte'): ?>
                                                                    🚗
                                                                    <?php break; ?>
                                                                <?php case ('Entretenimento'): ?>
                                                                    🎬
                                                                    <?php break; ?>
                                                                <?php case ('Saúde'): ?>
                                                                    🏥
                                                ...
                                                <!-- Badge de Status -->
                                                <div class="absolute -top-1 -right-1 w-6 h-6 <?php echo e($category->is_active ? 'bg-green-500' : 'bg-red-500'); ?> rounded-full flex items-center justify-center">
                                                    <span class="text-white text-xs"><?php echo e($category->is_active ? '✓' : '✗'); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-1">
                                                <div class="flex items-center mb-1">
                                                    <h4 class="font-bold text-gray-900 dark:text-gray-100 text-lg"><?php echo e($category->name); ?></h4>
                                                    <!-- Botão de Favorita -->
                                                ...
                                                <p class="text-gray-600 dark:text-gray-400 text-sm"><?php echo e($category->description ?? 'Categoria de transação'); ?></p>
                                                <div class="mt-2">
                                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-100 dark:bg-emerald-900 text-emerald-800 dark:text-emerald-200">
                                                        <!--[if BLOCK]><![endif]--><?php if($category->tipo === 'gasto'): ?>
                                                            💸 Despesa
                                                        <?php elseif($category->tipo === 'receita'): ?>
                                                            💵 Receita
                                                        <?php else: ?>
                                                            💰 Ambos
                                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div class="flex items-center space-x-2 ml-4">
                                            ...
                                            <a href="<?php echo e(route('categories.edit', $category->id_category)); ?>" class="p-2 text-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-900 rounded-xl transition-colors" title="Editar categoria">
                                                ✏️
                                            </a>
                    ...
                    <div class="mt-8">
                        <div class="bg-emerald-50 dark:bg-emerald-900/20 rounded-2xl p-4">
                            <?php echo e($paginatedTransactionCategories->links()); ?>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="bg-white bg-opacity-20 rounded-xl px-4 py-2">
                            <span class="text-white font-semibold"><?php echo e($categories->total()); ?> categorias</span>
                        </div>
                            ...
                            <div class="bg-slate-50 dark:bg-slate-700/50 rounded-xl p-4 border border-slate-200 dark:border-slate-600 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="w-10 h-10 rounded-lg flex items-center justify-center text-white text-lg"
                                         style="background: linear-gradient(135deg, <?php echo e($category->hexcolor_category ?? '#6366f1'); ?>, <?php echo e($category->hexcolor_category ?? '#6366f1'); ?>cc)">
                                ...
                                <h3 class="font-bold text-slate-900 dark:text-slate-100 text-base mb-2 truncate">
                                    <?php echo e($category->name ?? $category->description); ?>

                                </h3>
                                <p class="text-sm text-slate-600 dark:text-slate-400 mb-3 line-clamp-2">
                                    <?php echo e($category->desc_category ?? $category->description ?? 'Categoria de ' . ($category->type === 'product' ? 'produto' : 'transação')); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($activeTab === 'tips'): ?>
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
                ...
                <div class="mt-8 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-700 dark:to-slate-600 rounded-xl p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div class="text-center">
                            <div class="text-3xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($productCategories->count()); ?></div>
                            <div class="text-sm text-slate-600 dark:text-slate-400">Produtos</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-bold text-emerald-600 dark:text-emerald-400"><?php echo e($transactionCategories->count()); ?></div>
                            <div class="text-sm text-slate-600 dark:text-slate-400">Transações</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-bold text-green-600 dark:text-green-400"><?php echo e($categories->where('is_active', 1)->count()); ?></div>
                            <div class="text-sm text-slate-600 dark:text-slate-400">Ativas</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-bold text-red-600 dark:text-red-400"><?php echo e($categories->where('is_active', 0)->count()); ?></div>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showDeleteModal): ?>
        <div class="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
            <div class="relative bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 max-w-md w-full transform transition-all duration-300 scale-100">
                ...
                <!-- Conteúdo do Modal -->
                <div class="p-6">
                    <!--[if BLOCK]><![endif]--><?php if($deletingCategory): ?>
                        <!-- Informações da Categoria -->
                        <div class="text-center mb-5">
                            <div class="w-16 h-16 rounded-xl flex items-center justify-center text-white mx-auto mb-3 shadow-lg text-2xl"
                                 style="background: linear-gradient(135deg, <?php echo e($deletingCategory->hexcolor_category ?? '#6366f1'); ?>, <?php echo e($deletingCategory->hexcolor_category ?? '#6366f1'); ?>cc)">
                                <i class="fas fa-tag"></i>
                            </div>
                            <h4 class="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2"><?php echo e($deletingCategory->name ?? $deletingCategory->description); ?></h4>
                            <p class="text-slate-600 dark:text-slate-400 text-sm"><?php echo e($deletingCategory->desc_category ?? $deletingCategory->description); ?></p>
                        </div>
...
<?php /**PATH C:\projetos\FlowManeger\resources\views/livewire/categories/categories-index.blade.php ENDPATH**/ ?>