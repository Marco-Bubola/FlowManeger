...
--
-- Host: localhost
-- Tempo de geração: 03-Abr-2026 às 14:36
...
--
-- Estrutura da tabela `cashbook_uploads_history`
--
...
--
-- Estrutura da tabela `consortiums`
--
...
--
-- Estrutura da tabela `consortium_contemplations`
--
...
--
-- Estrutura da tabela `consortium_draws`
--
...
--
-- Estrutura da tabela `consortium_notifications`
--
...
--
-- Estrutura da tabela `consortium_participants`
--
...
--
-- Estrutura da tabela `consortium_payments`
--
...
--
-- Estrutura da tabela `daily_habits`
--
...
--
-- Estrutura da tabela `daily_habit_completions`
--
...
--
-- Estrutura da tabela `daily_habit_streaks`
--
...
--
-- Estrutura da tabela `goal_activities`
--
...
--
-- Estrutura da tabela `goal_attachments`
--
...
--
-- Estrutura da tabela `goal_boards`
--
...
--
-- Estrutura da tabela `goal_checklists`
--
...
--
-- Estrutura da tabela `goal_comments`
--
...
--
-- Estrutura da tabela `goal_habit`
--
...
--
-- Estrutura da tabela `goal_lists`
--
...
--
-- Estrutura da tabela `invoice_category_learning`
--
...
--
-- Estrutura da tabela `invoice_uploads_history`
--
...
--
-- Estrutura da tabela `lancamentos_recorrentes`
--
...
--
-- Estrutura da tabela `mercadolivre_orders`
--

CREATE TABLE `mercadolivre_orders` (
  `id` bigint UNSIGNED NOT NULL,
  `ml_order_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ID do pedido no ML',
  `ml_item_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ID do produto no ML',
  ...
  `buyer_nickname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `buyer_address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Endereço de entrega JSON',
  ...
  `currency_id` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'BRL',
  `order_status` enum('pending','paid','confirmed','ready_to_ship','shipped','delivered','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT 'Status do pedido',
  `payment_status` enum('pending','approved','in_process','rejected','cancelled','refunded') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT 'Status do pagamento',
  `payment_method` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Método de pagamento',
  `payment_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Tipo de pagamento (credit_card, pix, etc)',
  `shipping_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'ID do envio no ML',
  `tracking_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Código de rastreamento',
  `shipping_method` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Método de envio',
  ...
  `sync_status` enum('pending','imported','error') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `error_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
--
-- Estrutura da tabela `mercadolivre_products`
--
...
--
-- Estrutura da tabela `mercadolivre_sync_log`
--

CREATE TABLE `mercadolivre_sync_log` (
  `id` bigint UNSIGNED NOT NULL,
  `user_id` bigint UNSIGNED NOT NULL,
  `sync_type` enum('stock','price','product','order','status','full') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipo de sincronização realizada',
  `entity_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Product, Order, etc',
  `entity_id` bigint UNSIGNED DEFAULT NULL COMMENT 'ID da entidade',
  `action` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'create, update, delete, sync, import',
  `status` enum('success','error','warning') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Resultado da operação',
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Mensagem descritiva',
...
--
-- Estrutura da tabela `mercadolivre_tokens`
--
...
CREATE TABLE `mercadolivre_tokens` (
  ...
  `access_token` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Token de acesso',
  `refresh_token` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Token de renovação',
  `token_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Bearer',
  `expires_at` timestamp NOT NULL COMMENT 'Data/hora de expiração do token',
  `scope` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Permissões do token',
  `is_active` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'Token está ativo',
  `ml_nickname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nome do usuário no ML',
...
--
-- Estrutura da tabela `mercadolivre_webhooks`
--

CREATE TABLE `mercadolivre_webhooks` (
  `id` bigint UNSIGNED NOT NULL,
  `topic` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'orders, items, questions, claims, shipments',
  `resource` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'URL do recurso afetado',
...
--
-- Estrutura da tabela `ml_publications`
--
...
--
-- Estrutura da tabela `ml_publication_products`
--
...
--
-- Estrutura da tabela `ml_stock_logs`
--
...
CREATE TABLE `ml_stock_logs` (
  ...
  `operation_type` enum('ml_sale','manual_update','import_excel','internal_sale','sync_to_ml','adjustment','return') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipo de operação',
  ...
  `source` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Fonte da operação (ex: MercadoLivreWebhook, ProductController)',
  `ml_order_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'ID do pedido ML (se aplicável)',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Observações adicionais',
  `transaction_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'UUID da transação (agrupa operações atômicas)',
...
--
-- Estrutura da tabela `product_category_learning`
--
...
--
-- Estrutura da tabela `product_uploads_history`
--
...
--
-- Estrutura da tabela `produto_componentes`
--
...
--
-- Estrutura da tabela `sale_payments`
--
...
--
-- Estrutura da tabela `venda_parcelas`
--
...
--
-- Índices para tabela `cashbook_uploads_history`
--
...
--
-- Índices para tabela `consortiums`
--
...
--
-- Índices para tabela `consortium_contemplations`
--
...
--
-- Índices para tabela `consortium_draws`
--
...
--
-- Índices para tabela `consortium_notifications`
--
...
--
-- Índices para tabela `consortium_participants`
--
...
--
-- Índices para tabela `consortium_payments`
--
...
--
-- Índices para tabela `daily_habits`
--
...
--
-- Índices para tabela `daily_habit_completions`
--
...
--
-- Índices para tabela `daily_habit_streaks`
--
...
--
-- Índices para tabela `goal_activities`
--
ALTER TABLE `goal_activities`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `goal_attachments`
--
...
--
-- Índices para tabela `goal_boards`
--
...
--
-- Índices para tabela `goal_checklists`
--
...
--
-- Índices para tabela `goal_checklist_items`
--
...
--
-- Índices para tabela `goal_comments`
--
...
--
-- Índices para tabela `goal_habit`
--
...
--
-- Índices para tabela `goal_lists`
--
...
--
-- Índices para tabela `invoice_category_learning`
--
...
--
-- Índices para tabela `invoice_uploads_history`
--
...
--
-- Índices para tabela `lancamentos_recorrentes`
--
...
--
-- Índices para tabela `mercadolivre_orders`
--
...
--
-- Índices para tabela `mercadolivre_products`
--
ALTER TABLE `mercadolivre_products`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `mercadolivre_sync_log`
--
...
--
-- Índices para tabela `mercadolivre_tokens`
--
...
--
-- Índices para tabela `mercadolivre_webhooks`
--
...
--
-- Índices para tabela `ml_publications`
--
...
--
-- Índices para tabela `ml_publication_products`
--
...
--
-- Índices para tabela `ml_stock_logs`
--
...
--
-- Índices para tabela `product_category_learning`
--
...
--
-- Índices para tabela `product_uploads_history`
--
...
--
-- Índices para tabela `produto_componentes`
--
...
--
-- Índices para tabela `sale_payments`
--
...
--
-- Índices para tabela `venda_parcelas`
--
...
--
-- Limitadores para a tabela `banks`
--
ALTER TABLE `banks`
...
--
-- Limitadores para a tabela `cashbook_uploads_history`
--
ALTER TABLE `cashbook_uploads_history`
...
--
-- Limitadores para a tabela `consortium_draws`
--
ALTER TABLE `consortium_draws`
...
--
-- Limitadores para a tabela `consortium_notifications`
--
ALTER TABLE `consortium_notifications`
...
--
-- Limitadores para a tabela `consortium_participants`
--
ALTER TABLE `consortium_participants`
...
--
-- Limitadores para a tabela `consortium_payments`
--
ALTER TABLE `consortium_payments`
...
--
-- Limitadores para a tabela `daily_habit_streaks`
--
ALTER TABLE `daily_habit_streaks`
...
--
-- Limitadores para a tabela `goal_comments`
--
ALTER TABLE `goal_comments`
...
--
-- Limitadores para a tabela `goal_habit`
--
ALTER TABLE `goal_habit`
...
--
-- Limitadores para a tabela `goal_lists`
--
ALTER TABLE `goal_lists`
...
--
-- Limitadores para a tabela `invoice_category_learning`
--
ALTER TABLE `invoice_category_learning`
...
--
-- Limitadores para a tabela `product_category_learning`
--
ALTER TABLE `product_category_learning`
...
--
-- Limitadores para a tabela `sale_payments`
--
ALTER TABLE `sale_payments`
...
--
-- Limitadores para a tabela `targets`
--
ALTER TABLE `targets`
  ADD CONSTRAINT `targets_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Limitadores para a tabela `user_achievements`
--
ALTER TABLE `user_achievements`
...
--
-- Limitadores para a tabela `venda_parcelas`
--
ALTER TABLE `venda_parcelas`
