...
<div class="w-full">
    ...
    <x-sales-header
        title="Editar Cartão/Banco"
        description="Atualize as informações do seu cartão ou banco"
    ...
    <div class="relative flex-1">
        <form wire:submit.prevent="update" x-data="{ cardNumber: @entangle('description') }">
