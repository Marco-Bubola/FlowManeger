    ...
    <x-sales-header title="Adicionar Novo Cartão/Banco" description="Cadastre um novo cartão ou banco para gerenciar suas finanças"
        ...
        <x-slot name="actions">
            ...
            <button type="submit" form="bank-form"
                class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white font-bold rounded-xl transition-all duration-200 shadow-lg hover:shadow-2xl hover:scale-105">
                <i class="bi bi-check-lg"></i>
                Salvar Cartão
            </button>
        </x-slot>
    </x-sales-header>
    <form id="bank-form" wire:submit.prevent="store" x-data="{ cardNumber: @entangle('description') }" class="flex-1 w-full flex flex-col gap-8 px-4 md:px-10 pb-8 overflow-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
                <label for="name" class="flex items-center text-lg font-bold text-slate-800 dark:text-slate-200 mb-3">
            ...
            <div>
                <label for="description" class="flex items-center text-lg font-bold text-slate-800 dark:text-slate-200 mb-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
                <label for="start_date" class="flex items-center text-lg font-bold text-slate-800 dark:text-slate-200 mb-3">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="start_date" wire:model="start_date" placeholder="Selecione a data de abertura..."
            ...
            <div>
                <label for="end_date" class="flex items-center text-lg font-bold text-slate-800 dark:text-slate-200 mb-3">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="end_date" wire:model="end_date" placeholder="Selecione a data de fechamento..."
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        Livewire.hook('message.processed', (message, component) => {
            setTimeout(() => {
                if (document.getElementById('start_date') && !document.getElementById('start_date')._flatpickr) {
                ...
                if (document.getElementById('end_date') && !document.getElementById('end_date')._flatpickr) {
                    flatpickr('#end_date', {
                        ...defaultConfig,
                        onChange: function(selectedDates, dateStr) {
                            @this.set('end_date', dateStr);
