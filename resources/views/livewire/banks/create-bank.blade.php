...
<div class="w-full">
    ...
    <x-sales-header :back-route="route('banks.index')" title="Adicionar Novo Cartão/Banco" description="Cadastre um novo cartão ou banco para gerenciar suas finanças.">
        <x-slot name="actions">
