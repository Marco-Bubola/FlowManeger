@push('styles')
<style>
.promotions-header-bg{background:linear-gradient(135deg,rgba(255,255,255,.82) 0%,rgba(254,243,199,.90) 40%,rgba(251,191,36,.50) 100%);}
...
<div class="promotions-page min-h-screen"
    ...
    {{-- ============================================================
         HEADER
    ============================================================ --}}
    <div class="promotions-header-bg border-b border-amber-200/60 dark:border-amber-700/30 px-4 sm:px-6 py-5 mb-5
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex items-center gap-2">
                    <button wire:click="loadPromotions" title="Atualizar"
        ...
        @elseif(count($promotions) === 0)
            <div class="flex flex-col items-center justify-center py-24 text-center">
                <div class="w-20 h-20 rounded-full bg-amber-50 dark:bg-amber-900/20 flex items-center justify-center mb-4">
                    <i class="bi bi-percent text-4xl text-amber-300 dark:text-amber-600"></i>
                </div>
                <h3 class="text-lg font-bold text-slate-700 dark:text-slate-300 mb-1">Nenhuma promoção encontrada</h3>
