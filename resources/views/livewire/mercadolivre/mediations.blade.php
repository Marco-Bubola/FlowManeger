@push('styles')
<style>
.mediations-header-bg{background:linear-gradient(135deg,rgba(255,255,255,.82) 0%,rgba(254,243,199,.90) 40%,rgba(251,191,36,.50) 100%);}
...
<div class="mediations-page min-h-screen"
    ...
    {{-- ============================================================
         HEADER
    ============================================================ --}}
    <div class="mediations-header-bg border-b border-amber-200/60 dark:border-amber-700/30 px-4 sm:px-6 py-5 mb-5
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex items-center gap-2">
                    <button wire:click="loadClaims" title="Atualizar"
