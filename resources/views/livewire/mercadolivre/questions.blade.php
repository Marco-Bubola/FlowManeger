...
<div class="questions-page min-h-screen"
    ...
    {{-- ============================================================
         HEADER – AMBER / ML
    ============================================================ --}}
    <div class="questions-header-bg border-b border-amber-200/60 dark:border-amber-700/30 px-4 sm:px-6 py-5 mb-5
                ...
                <div class="flex items-center gap-4">
                    <div class="relative w-14 h-14 flex-shrink-0">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-yellow-400 via-amber-500 to-orange-500
                            ...
                            <i class="bi bi-chat-dots-fill text-2xl text-white"></i>
                        </div>
