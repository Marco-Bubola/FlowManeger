            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Modifique os dados da transação</p>
                    </div>
                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input wire:model="value" type="number" step="0.01" min="0.01" 
                                           class="w-full pl-10 pr-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('value') border-red-500 @else border-gray-300 @enderror"
                                           placeholder="0,00">
                                </div>
                            ...
                            <div>
                                ...
                                <input wire:model="description" type="text" 
                                       class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-500 @else border-gray-300 @enderror"
                            ...
                            <div>
                                ...
                                <input wire:model="date" type="date" 
                                       class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('date') border-red-500 @else border-gray-300 @enderror">
                            ...
                            <div>
                                ...
                                <select wire:model="category_id" 
                                        class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('category_id') border-red-500 @else border-gray-300 @enderror">
                            ...
                            <div>
                                ...
                                <select wire:model="type_id" 
                                        class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('type_id') border-red-500 @else border-gray-300 @enderror">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select wire:model="client_id" 
                                        class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('client_id') border-red-500 @else border-gray-300 @enderror">
                            ...
                            <div>
                                ...
                                <select wire:model="segment_id" 
                                        class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('segment_id') border-red-500 @else border-gray-300 @enderror">
                            ...
                            <div>
                                ...
                                <textarea wire:model="note" rows="3" 
                                          class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('note') border-red-500 @else border-gray-300 @enderror"
                            ...
                            <div>
                                ...
                                <input wire:model="attachment" type="file" 
                                       class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('attachment') border-red-500 @else border-gray-300 @enderror"
