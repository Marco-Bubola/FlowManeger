<div x-data="{ currentStep: 1 }" class=" w-full py-8">
    <style>
    ...
    <!-- Loading Overlay -->
    <div wire:loading.delay.long wire:target="store"
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl border border-white/20 dark:border-slate-700/50 backdrop-blur-xl">
            <div class="flex flex-col items-center">
                ...
                <h3 class="text-lg font-bold text-slate-800 dark:text-slate-200 mb-2">Salvando Cliente</h3>
