<div class="w-full">
    <!-- Modern Full-Width Invoice Edit Form -->
            ...
            <div class="max-w-7xl mx-auto px-6 py-8">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-6">
                        <div class="relative">
                            <div class="w-16 h-16 bg-gradient-to-br from-yellow-500 via-orange-500 to-red-500 rounded-2xl flex items-center justify-center shadow-xl">
                        ...
                        <div>
                            <h1 class="text-3xl font-black bg-gradient-to-r from-gray-900 via-orange-800 to-red-800 dark:from-white dark:via-orange-200 dark:to-red-200 bg-clip-text text-transparent">
                                ✏️ Editar Transação
                            </h1>
                            <p class="text-sm text-gray-600 dark:text-gray-400 font-medium mt-1">
                                🔄 Atualize os dados da sua transação com facilidade
                            </p>
                        </div>
                    </div>
                    <div class="hidden md:flex items-center space-x-4">
                        <a href="{{ route('invoices.index', ['bankId' => $invoice->id_bank]) }}"
                           class="flex items-center space-x-2 bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300">
                            <svg class="w-4 h-4 text-gray-600 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                            </svg>
                            <span class="text-sm text-gray-600 dark:text-gray-400">Voltar</span>
                        </a>
            ...
            <form wire:submit="save" class="space-y-12">
                ...
                <div class="space-y-6">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-2xl font-black text-gray-900 dark:text-white">💼 Informações da Transação</h2>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Atualize os detalhes principais da transação</p>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Configure datas e parcelas</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <!-- Data da Transação -->
                        <div class="space-y-3">
                            <label for="invoice_date" class="flex items-center text-sm font-bold text-gray-900 dark:text-white">
                ...
                <div class="flex items-center justify-between pt-8 border-t border-gray-200/50 dark:border-gray-700/50">
                    ...
                    <button type="submit"
                            class="inline-flex items-center px-12 py-4 text-base font-bold text-white bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 hover:from-yellow-600 hover:via-orange-600 hover:to-red-600 rounded-xl focus:outline-none focus:ring-4 focus:ring-orange-500/30 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-2xl max-w-sm mx-4">
                        <div class="flex flex-col items-center">
                            <div class="relative w-16 h-16 mb-6">
                                <div class="absolute inset-0 border-4 border-orange-200 dark:border-orange-700 rounded-full"></div>
                                <div class="absolute inset-0 border-4 border-orange-500 border-t-transparent rounded-full animate-spin"></div>
                            </div>
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Atualizando Transação</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400 text-center">Aguarde enquanto salvamos as alterações...</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const firstInput = document.querySelector('input[id="description"]');
            if (firstInput) {
            ...
            function updateFormProgress() {
                const requiredFields = ['description', 'value', 'category_id', 'invoice_date'];
                let completed = 0;
            ...
            // Enhanced category select interaction
            ...
            // Enhanced client select interaction
            ...
            if (form2) {
                form2.classList.add('animate-fade-in-up');
            }
