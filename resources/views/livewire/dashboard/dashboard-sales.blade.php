<div x-data="{ activeTab: 'overview' }" class="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-800">
        ...
        <div class="relative w-full px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex space-x-1 bg-white/30 dark:bg-gray-800/30 backdrop-blur-lg rounded-2xl p-1 border border-white/20 dark:border-gray-600/20">
                ...
                <button @click="activeTab = 'insights'"
                        :class="activeTab === 'insights' ? 'bg-white dark:bg-gray-800 text-purple-600 dark:text-purple-400 shadow-lg' : 'text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200'"
                        class="flex items-center px-6 py-3 rounded-xl font-semibold transition-all duration-300">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button @click="activeTab = 'forecast'"
                        :class="activeTab === 'forecast' ? 'bg-white dark:bg-gray-800 text-purple-600 dark:text-purple-400 shadow-lg' : 'text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200'"
                        class="flex items-center px-6 py-3 rounded-xl font-semibold transition-all duration-300">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl">
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">
                                {{ number_format((($vendasAnoAtual / ($vendasAnoAtual * 1.25)) * 100), 1) }}% da meta alcançada
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <!-- Insights IA Tab -->
        <div x-show="activeTab === 'insights'" x-transition:enter="transition ease-out duration-300"
             x-transition:enter-start="opacity-0 transform translate-x-4"
             x-transition:enter-end="opacity-100 transform translate-x-0">

            <!-- AI-Powered Insights Header -->
            <div class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-3xl p-8 mb-10 text-white">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-3xl font-bold">Insights Inteligentes</h2>
                            <p class="text-lg opacity-90">Análises baseadas em IA e Machine Learning</p>
                        </div>
                    </div>
                    <div class="text-right">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="p-3 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Velocidade de Vendas</h3>
                    <div class="text-3xl font-black text-blue-600 dark:text-blue-400 mb-2">
                        {{ number_format($totalVendas / max(1, $totalDiasAtivos), 1) }}
                    </div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">vendas/dia em média</p>
                    <div class="mt-4 flex items-center">
                        <div class="flex-1 bg-blue-200 dark:bg-blue-800 rounded-full h-2">
                            <div class="bg-blue-500 h-2 rounded-full" style="width: {{ min(100, ($totalVendas / max(1, $totalDiasAtivos)) * 10) }}%"></div>
                        </div>
                        <span class="ml-2 text-xs text-gray-500">{{ min(100, round(($totalVendas / max(1, $totalDiasAtivos)) * 10)) }}%</span>
                    </div>
                </div>
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="p-3 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                            </svg>
                        </div>
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Satisfação (IA)</h3>
                    <div class="text-3xl font-black text-green-600 dark:text-green-400 mb-2">
                        {{ number_format(95.7, 1) }}%
                    </div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">baseado em padrões de compra</p>
                    <div class="mt-4 flex items-center">
                        ...
                        <span class="ml-2 text-xs text-gray-500">Excelente</span>
                    </div>
                </div>
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="p-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z"></path>
                            </svg>
                        </div>
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Oportunidade</h3>
                    <div class="text-3xl font-black text-purple-600 dark:text-purple-400 mb-2">
                        R$ {{ number_format($totalFaturamento * 0.35, 0, ',', '.') }}
                    </div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">potencial de crescimento</p>
                    <div class="mt-4 flex items-center">
                        ...
                        <span class="ml-2 text-xs text-gray-500">35%</span>
                    </div>
                </div>
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="p-3 bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                            </svg>
                        </div>
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Score Preditivo</h3>
                    <div class="text-3xl font-black text-orange-600 dark:text-orange-400 mb-2">
                        {{ number_format(87.3, 1) }}
                    </div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">performance geral</p>
                    <div class="mt-4 flex items-center">
                        ...
                        <span class="ml-2 text-xs text-gray-500">Ótimo</span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8">
                    ...
                    <div class="space-y-4">
                        <div class="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl border border-blue-200/50 dark:border-blue-700/50">
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-lg font-bold text-blue-800 dark:text-blue-400 mb-2">Foque em Clientes Recorrentes</h4>
                                    <p class="text-sm text-blue-700 dark:text-blue-300 mb-3">
                                        IA detectou que clientes recorrentes geram 3.2x mais receita. Priorize estratégias de retenção.
                                    </p>
                                    <div class="flex items-center space-x-2">
                                        <span class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-medium bg-blue-100 dark:bg-blue-800/50 text-blue-800 dark:text-blue-300">
                                            Impacto: Alto
                                        </span>
                                        <span class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-medium bg-green-100 dark:bg-green-800/50 text-green-800 dark:text-green-300">
                                            +R$ {{ number_format($totalFaturamento * 0.12, 0, ',', '.') }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="p-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl border border-green-200/50 dark:border-green-700/50">
                            <div class="flex items-start space-x-4">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-lg font-bold text-green-800 dark:text-green-400 mb-2">Otimize Horários de Venda</h4>
                                    <p class="text-sm text-green-700 dark:text-green-300 mb-3">
                                        Padrão IA: 68% das vendas acontecem entre 14h-17h. Concentre esforços neste período.
                                    </p>
                                    <div class="flex items-center space-x-2">
                                        <span class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-medium bg-green-100 dark:bg-green-800/50 text-green-800 dark:text-green-300">
                                            Implementação: Fácil
                        ...
                        <div class="p-6 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl border border-purple-200/50 dark:border-purple-700/50">
                            <div class="flex items-start space-x-4">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-lg font-bold text-purple-800 dark:text-purple-400 mb-2">Diversifique Portfolio</h4>
                                    <p class="text-sm text-purple-700 dark:text-purple-300 mb-3">
                                        IA sugere expansão para 2-3 categorias relacionadas com base no perfil dos clientes atuais.
                                    </p>
                                    <div class="flex items-center space-x-2">
                                        <span class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-medium bg-purple-100 dark:bg-purple-800/50 text-purple-800 dark:text-purple-300">
                                            Risco: Baixo
                                        </span>
                                        <span class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-medium bg-purple-100 dark:bg-purple-800/50 text-purple-800 dark:text-purple-300">
                                            ROI: 180%
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
                        ...
                        Perfil Inteligente de Clientes
                    </h3>
                    ...
                    <div class="space-y-6">
                        <div class="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl">
                            <div class="flex items-center justify-between mb-3">
                                <h4 class="text-lg font-bold text-blue-800 dark:text-blue-400">Clientes Premium</h4>
                                <span class="text-2xl font-black text-blue-600 dark:text-blue-400">{{ number_format($totalClientes * 0.23) }}</span>
                            </div>
                            <p class="text-sm text-blue-700 dark:text-blue-300 mb-3">
                                Gastam R$ {{ number_format($totalFaturamento / max(1, $totalClientes) * 2.1, 0, ',', '.') }}+ por transação
                            </p>
                            <div class="w-full bg-blue-200 dark:bg-blue-800 rounded-full h-2">
                                <div class="bg-blue-500 h-2 rounded-full" style="width: 75%"></div>
                            </div>
                            <p class="text-xs text-blue-600 dark:text-blue-400 mt-1">75% de satisfação</p>
                        </div>

                        <div class="p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl">
                            <div class="flex items-center justify-between mb-3">
                                <h4 class="text-lg font-bold text-green-800 dark:text-green-400">Clientes Regulares</h4>
                                <span class="text-2xl font-black text-green-600 dark:text-green-400">{{ number_format($totalClientes * 0.52) }}</span>
                            </div>
                            <p class="text-sm text-green-700 dark:text-green-300 mb-3">
                                Compram a cada {{ number_format(45) }} dias em média
                            </p>
                            <div class="w-full bg-green-200 dark:bg-green-800 rounded-full h-2">
                                <div class="bg-green-500 h-2 rounded-full" style="width: 52%"></div>
                            </div>
                            <p class="text-xs text-green-600 dark:text-green-400 mt-1">52% da base total</p>
                        </div>

                        <div class="p-4 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-2xl">
                            <div class="flex items-center justify-between mb-3">
                                <h4 class="text-lg font-bold text-orange-800 dark:text-orange-400">Clientes em Risco</h4>
                                <span class="text-2xl font-black text-orange-600 dark:text-orange-400">{{ number_format($totalClientes * 0.25) }}</span>
                            </div>
                            ...
                            <p class="text-xs text-orange-600 dark:text-orange-400 mt-1">Necessitam reativação</p>
                        </div>
                    </div>

                    <!-- Action Buttons -->
                    <div class="mt-6 grid grid-cols-2 gap-3">
                        <button class="flex items-center justify-center px-4 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-sm font-semibold rounded-xl hover:from-blue-600 hover:to-indigo-600 transition-all duration-300">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.367 2.684 3 3 0 00-5.367-2.684z"></path>
                            </svg>
                            Segmentar
                        </button>
                        <button class="flex items-center justify-center px-4 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white text-sm font-semibold rounded-xl hover:from-green-600 hover:to-emerald-600 transition-all duration-300">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Advanced Charts for Insights -->
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <!-- Predictive Analytics Chart -->
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-6">Previsão IA - 90 Dias</h3>
                    <div class="h-64">
                ...
                <!-- Customer Lifetime Value -->
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-6">CLV por Segmento</h3>
                    <div class="h-64">
                        <div id="clvChart"></div>
                    </div>
                </div>
                ...
                <!-- Churn Risk -->
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-6">Risco de Churn</h3>
                    <div class="h-64">
        ...
        <!-- Forecast Tab -->
        <div x-show="activeTab === 'forecast'" x-transition:enter="transition ease-out duration-300"
             x-transition:enter-start="opacity-0 transform translate-x-4"
             x-transition:enter-end="opacity-100 transform translate-x-0">

            <!-- Forecasting Header -->
            <div class="bg-gradient-to-r from-emerald-500 via-blue-500 to-purple-500 rounded-3xl p-8 mb-10 text-white">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <div class="p-4 bg-white/20 rounded-2xl backdrop-blur-lg">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <h2 class="text-3xl font-bold">Previsões & Metas</h2>
                            <p class="text-lg opacity-90">Projeções baseadas em dados históricos e IA</p>
                        </div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm opacity-80">Precisão do modelo</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-xs font-medium text-gray-500 dark:text-gray-400">PRÓXIMO MÊS</span>
                    </div>
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Previsão de Vendas</h3>
                    <div class="text-3xl font-black text-blue-600 dark:text-blue-400 mb-2">
                        R$ {{ number_format($totalFaturamento * 1.08, 0, ',', '.') }}
                    </div>
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">
                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                            </svg>
                            +8%
                        </span>
                        <span class="text-xs text-gray-600 dark:text-gray-400">vs mês atual</span>
                    </div>
                </div>
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="p-3 bg-gradient-to-r from-emerald-500 to-green-500 rounded-2xl">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                            </svg>
                        </div>
                        <span class="text-xs font-medium text-gray-500 dark:text-gray-400">PRÓXIMO TRIMESTRE</span>
                    </div>
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Meta Trimestral</h3>
                    <div class="text-3xl font-black text-emerald-600 dark:text-emerald-400 mb-2">
                        R$ {{ number_format($totalFaturamento * 3.25, 0, ',', '.') }}
                    </div>
                    <div class="w-full bg-emerald-200 dark:bg-emerald-800 rounded-full h-2 mb-2">
                        <div class="bg-emerald-500 h-2 rounded-full" style="width: {{ min(100, ($totalFaturamento / ($totalFaturamento * 3.25)) * 100) }}%"></div>
                    </div>
                    <span class="text-xs text-gray-600 dark:text-gray-400">{{ number_format(min(100, ($totalFaturamento / ($totalFaturamento * 3.25)) * 100), 1) }}% da meta</span>
                </div>
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-xs font-medium text-gray-500 dark:text-gray-400">META ANUAL</span>
                    </div>
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Objetivo 2025</h3>
                    <div class="text-3xl font-black text-purple-600 dark:text-purple-400 mb-2">
                        R$ {{ number_format($totalFaturamento * 12.5, 0, ',', '.') }}
                    </div>
                    <div class="w-full bg-purple-200 dark:bg-purple-800 rounded-full h-2 mb-2">
                        <div class="bg-purple-500 h-2 rounded-full" style="width: {{ min(100, ($totalFaturamento / ($totalFaturamento * 12.5)) * 100) }}%"></div>
                    </div>
                    <span class="text-xs text-gray-600 dark:text-gray-400">{{ number_format(min(100, ($totalFaturamento / ($totalFaturamento * 12.5)) * 100), 1) }}% alcançado</span>
                </div>
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-xs font-medium text-gray-500 dark:text-gray-400">PROBABILIDADE</span>
                    </div>
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Chance de Sucesso</h3>
                    <div class="text-3xl font-black text-orange-600 dark:text-orange-400 mb-2">89.7%</div>
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">
                            Alto
                        </span>
                        <span class="text-xs text-gray-600 dark:text-gray-400">confiança IA</span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Previsão de Receita - 12 Meses</h3>
                    <div class="h-80">
                ...
                <!-- Scenario Analysis -->
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Análise de Cenários</h3>
                    <div class="space-y-6">
                        <!-- Optimistic Scenario -->
                        <div class="p-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl">
                            <div class="flex items-center justify-between mb-4">
                                <h4 class="text-lg font-bold text-green-800 dark:text-green-400">Cenário Otimista</h4>
                                <span class="text-2xl font-black text-green-600 dark:text-green-400">+25%</span>
                            </div>
                            <p class="text-sm text-green-700 dark:text-green-300 mb-3">
                                Com campanhas agressivas e expansão do portfólio
                            </p>
                            ...
                            <p class="text-xs text-green-600 dark:text-green-400 mt-1">
                                R$ {{ number_format($totalFaturamento * 1.25, 0, ',', '.') }} - Probabilidade: 35%
                            </p>
                        </div>

                        <!-- Realistic Scenario -->
                        <div class="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl">
                            <div class="flex items-center justify-between mb-4">
                                <h4 class="text-lg font-bold text-blue-800 dark:text-blue-400">Cenário Realista</h4>
                                <span class="text-2xl font-black text-blue-600 dark:text-blue-400">+12%</span>
                            </div>
                            <p class="text-sm text-blue-700 dark:text-blue-300 mb-3">
                                Crescimento natural baseado no histórico atual
                            </p>
                            ...
                            <p class="text-xs text-blue-600 dark:text-blue-400 mt-1">
                                R$ {{ number_format($totalFaturamento * 1.12, 0, ',', '.') }} - Probabilidade: 80%
                            </p>
                        </div>

                        <!-- Conservative Scenario -->
                        <div class="p-6 bg-gradient-to-r from-orange-50 to-yellow-50 dark:from-orange-900/20 dark:to-yellow-900/20 rounded-2xl">
                            <div class="flex items-center justify-between mb-4">
                                <h4 class="text-lg font-bold text-orange-800 dark:text-orange-400">Cenário Conservador</h4>
                                <span class="text-2xl font-black text-orange-600 dark:text-orange-400">+5%</span>
                            </div>
                            <p class="text-sm text-orange-700 dark:text-orange-300 mb-3">
                                Crescimento mínimo considerando desafios do mercado
                            </p>
                            ...
                            <p class="text-xs text-orange-600 dark:text-orange-400 mt-1">
                                R$ {{ number_format($totalFaturamento * 1.05, 0, ',', '.') }} - Probabilidade: 95%
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl border border-blue-200/50 dark:border-blue-700/50">
                        <div class="flex items-center space-x-3 mb-4">
                            ...
                            <h4 class="font-bold text-blue-800 dark:text-blue-400">Marketing Digital</h4>
                        </div>
                        ...
                        <div class="mt-4 p-2 bg-blue-100 dark:bg-blue-800/50 rounded-lg">
                            <span class="text-xs font-medium text-blue-800 dark:text-blue-300">ROI esperado: +18%</span>
                        </div>
                    </div>
                    ...
                    <div class="p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl border border-green-200/50 dark:border-green-700/50">
                        <div class="flex items-center space-x-3 mb-4">
                            ...
                            <h4 class="font-bold text-green-800 dark:text-green-400">Produtos & Serviços</h4>
                        </div>
                        ...
                        <div class="mt-4 p-2 bg-green-100 dark:bg-green-800/50 rounded-lg">
                            <span class="text-xs font-medium text-green-800 dark:text-green-300">Aumento de ticket: +22%</span>
                        </div>
                    </div>
                    ...
                    <div class="p-6 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl border border-purple-200/50 dark:border-purple-700/50">
                        <div class="flex items-center space-x-3 mb-4">
                            ...
                            <h4 class="font-bold text-purple-800 dark:text-purple-400">Relacionamento</h4>
                        </div>
                        ...
                        <div class="mt-4 p-2 bg-purple-100 dark:bg-purple-800/50 rounded-lg">
                            <span class="text-xs font-medium text-purple-800 dark:text-purple-300">Retenção: +15%</span>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Função para renderizar gráficos quando necessário
    ...
    // Função para renderizar gráficos da aba Performance
    function renderPerformanceCharts() {
        if (isElementVisible("#performanceChart")) {
            const performanceOptions = {
                ...
                colors: [colors.primary],
                xaxis: {
                    categories: ['Eficiência', 'Conversão', 'Retenção'],
                    labels: {
                        style: {
                            colors: isDark ? '#9CA3AF' : '#6B7280'
                        }
    ...
    // Função para renderizar gráficos da aba Insights
    function renderInsightsCharts() {
        // Predictive Analytics Chart
        if (isElementVisible("#predictiveChart")) {
            const predictiveOptions = {
                series: [{
                    name: 'Vendas Reais',
                    data: @json($vendasPorMesEvolucao).slice(-6).map(item => parseFloat(item.total))
                }, {
                    name: 'Previsão IA',
                    data: [null, null, null, null, null, {{ $totalFaturamento * 1.08 }}, {{ $totalFaturamento * 1.15 }}, {{ $totalFaturamento * 1.22 }}]
                }],
                chart: {
                    type: 'line',
                    height: 250,
                ...
                xaxis: {
                    categories: ['Mês -3', 'Mês -2', 'Mês -1', 'Atual', 'Próx 1', 'Próx 2', 'Próx 3'],
                    labels: {
                        style: {
                            colors: isDark ? '#9CA3AF' : '#6B7280'
                        }
                ...
                yaxis: {
                    labels: {
                        ...
                        formatter: function (value) {
                            return value ? 'R$ ' + new Intl.NumberFormat('pt-BR', { notation: 'compact' }).format(value) : '';
                        }
                    }
                },
                tooltip: {
            ...
            const predictiveChart = new ApexCharts(document.querySelector("#predictiveChart"), predictiveOptions);
            predictiveChart.render();
        }

        // CLV Chart
        if (isElementVisible("#clvChart")) {
            const clvOptions = {
                series: [75, 52, 25],
                chart: {
                    type: 'donut',
                ...
                labels: ['Premium', 'Regular', 'Em Risco'],
            ...
            const clvChart = new ApexCharts(document.querySelector("#clvChart"), clvOptions);
            clvChart.render();
        }

        // Churn Risk Chart
        if (isElementVisible("#churnChart")) {
            const churnOptions = {
                series: [{
                    name: 'Risco de Churn',
                    data: [15, 25, 35, 20, 18, 12, 8]
                }],
                chart: {
                    type: 'area',
                    height: 250,
                ...
                xaxis: {
                    categories: ['0-30d', '31-60d', '61-90d', '91-120d', '121-150d', '151-180d', '180+d'],
                    labels: {
                        style: {
                            colors: isDark ? '#9CA3AF' : '#6B7280'
                        }
    ...
    // Função para renderizar gráficos da aba Forecast
    function renderForecastCharts() {
        // Revenue Forecast Chart
        if (isElementVisible("#revenueForecastChart")) {
            const forecastOptions = {
                series: [{
                    ...
                    name: 'Previsão',
                    data: [null, null, null, null, null, {{ $totalFaturamento * 1.08 }}, {{ $totalFaturamento * 1.15 }}, {{ $totalFaturamento * 1.22 }}, {{ $totalFaturamento * 1.18 }}, {{ $totalFaturamento * 1.25 }}, {{ $totalFaturamento * 1.32 }}, {{ $totalFaturamento * 1.28 }}]
                }, {
                    name: 'Meta',
                    data: Array(12).fill({{ $totalFaturamento * 1.2 }})
                }],
                chart: {
                    type: 'line',
                    height: 320,
            ...
            const forecastChart = new ApexCharts(document.querySelector("#revenueForecastChart"), forecastOptions);
            forecastChart.render();
        }
    }

    // Observer para mudanças de aba - Corrigido
    ...
    tabButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            console.log('Tab changed to:', tabName); // Debug
            renderChartsInTab(tabName);
        });
    });

    // Renderizar gráficos da aba inicial
    renderChartsInTab('overview');
