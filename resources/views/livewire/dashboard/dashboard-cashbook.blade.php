<div x-data="{ activeTab: 'overview' }" class="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-800">
        ...
        <div x-show="activeTab === 'forecasting'" x-transition:enter="transition ease-out duration-300"
            ...
            <!-- Forecasting Cards -->
                    <div class="relative">
                        ...
                        <div class="text-3xl font-black mb-2">R$ {{ number_format($totalInvoicesBancos, 0, ',', '.') }}</div>
                        <div class="text-sm opacity-90">Total de Faturas</div>
                    </div>
                    <div class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-orange-300 to-red-300"></div>
                </div>

                <!-- Saldo Total Bancos -->
                <div class="group relative overflow-hidden bg-gradient-to-br {{ $saldoTotalBancos >= 0 ? 'from-emerald-400 via-emerald-500 to-green-600' : 'from-red-400 via-red-500 to-rose-600' }} rounded-3xl p-6 text-white shadow-2xl hover:shadow-emerald-500/25 transition-all duration-500 hover:scale-105">
                    <div class="absolute top-0 right-0 -mt-4 -mr-4 w-20 h-20 bg-white/10 rounded-full blur-2xl"></div>
                    <div class="relative">
                        <div class="flex items-center justify-between mb-4">
                            <div class="p-3 bg-white/20 rounded-2xl backdrop-blur-lg">
                        ...
                        <div class="text-3xl font-black mb-2">R$ {{ number_format(abs($saldoTotalBancos), 0, ',', '.') }}</div>
                        <div class="text-sm opacity-90">Saldo Total Bancos</div>
                    </div>
                    <div class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r {{ $saldoTotalBancos >= 0 ? 'from-emerald-300 to-green-300' : 'from-red-300 to-rose-300' }}"></div>
                </div>
                ...
                <div class="group relative overflow-hidden bg-gradient-to-br from-red-400 via-red-500 to-rose-600 rounded-3xl p-6 text-white shadow-2xl hover:shadow-red-500/25 transition-all duration-500 hover:scale-105">
                    ...
                    <div class="relative">
                        ...
                        <div class="text-3xl font-black mb-2">R$ {{ number_format($totalSaidasBancos, 0, ',', '.') }}</div>
                        <div class="text-sm opacity-90">Total de Saídas</div>
                    </div>
                    <div class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-red-300 to-rose-300"></div>
                </div>
            </div>
            ...
            <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <a href="{{ route('banks.index') }}"
                       class="group inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-sm font-semibold rounded-xl hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
                        <svg class="w-4 h-4 mr-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
                        </svg>
                        Gerenciar Bancos
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-gray-200/50 dark:border-gray-700/50">
                                <th class="text-left py-4 px-6 font-bold text-gray-900 dark:text-white bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 first:rounded-l-xl">Banco</th>
                                <th class="text-right py-4 px-6 font-bold text-gray-900 dark:text-white bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700">Qtd Faturas</th>
                                <th class="text-right py-4 px-6 font-bold text-gray-900 dark:text-white bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700">Total</th>
                                <th class="text-right py-4 px-6 font-bold text-gray-900 dark:text-white bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700">Média</th>
                                <th class="text-right py-4 px-6 font-bold text-gray-900 dark:text-white bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 last:rounded-r-xl">Saldo</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="border-b border-gray-100/50 dark:border-gray-700/50 hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-colors">
                                <td class="py-4 px-6">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p class="font-bold text-gray-900 dark:text-white">{{ $banco['nome'] }}</p>
                                ...
                                <td class="py-4 px-6 text-right font-bold text-red-600 dark:text-red-400">
                                    R$ {{ number_format($banco['total_invoices'], 2, ',', '.') }}
                                </td>
                                <td class="py-4 px-6 text-right font-medium text-gray-900 dark:text-white">
                                    R$ {{ number_format($banco['media_invoices'], 2, ',', '.') }}
                                </td>
                                <td class="py-4 px-6 text-right font-bold {{ $banco['saldo'] >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                ...
                <div class="text-center py-16">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Nenhum banco cadastrado</h3>
                    <p class="text-gray-500 dark:text-gray-400 mb-6">Adicione bancos para visualizar informações detalhadas</p>
                    <a href="{{ route('banks.index') }}"
                       class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold rounded-xl hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 shadow-lg hover:shadow-xl">
