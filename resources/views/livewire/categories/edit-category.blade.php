...
<div class="edit-category-page w-full mobile-393-base">
    <link rel="stylesheet" href="{{ asset('assets/css/responsive/edit-category-mobile.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/responsive/edit-category-iphone15.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/responsive/edit-category-ipad-portrait.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/responsive/edit-category-ipad-landscape.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/responsive/edit-category-notebook.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/responsive/edit-category-ultrawide.css') }}">
        ...
        <div class="relative px-6 py-4">
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                <div class="flex items-center gap-4">
                    <div class="relative flex items-center justify-center w-12 h-12 rounded-xl shadow-md shadow-indigo-400/20"
                         style="background: linear-gradient(135deg, {{ $hexcolor_category }}, {{ $hexcolor_category }}dd)">
                        <i class="{{ $icone }} text-white text-2xl"></i>
                    ...
                    <div class="space-y-1">
                        <div class="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 mb-1">
                            ...
                            <span class="text-slate-800 dark:text-slate-200 font-medium">Editar Categoria</span>
                        </div>
                        <h1 class="text-2xl lg:text-3xl font-bold text-slate-800 dark:text-slate-100">
                            {{ $name }}
                        </h1>
                        <p class="text-sm text-slate-600 dark:text-slate-400">Edite as configurações desta categoria</p>
                    </div>
                </div>
    ...
    <form id="category-form" wire:submit.prevent="save">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <!-- Coluna 3: Configurações Avançadas -->
            <div class="space-y-4">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
                    ...
                    <div class="p-4 space-y-4">
                        ...
                        <!-- Tipo de Transação -->
                        <div>
                            <label class="text-sm font-medium text-slate-700 dark:text-slate-300 mb-2 block">Tipo de Transação</label>
                            <select wire:model="tipo" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white">
