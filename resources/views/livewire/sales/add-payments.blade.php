        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">
                    <i class="bi bi-plus-circle text-green-600 dark:text-green-400 mr-3"></i>Adicionar Pagamentos - Venda #{{ $sale->id }}
                </h1>
        ...
        <form wire:submit.prevent="addPayments">
            ...
            <div class="mt-8 p-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="text-center">
                        <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">
                            Valor Final Restante
                        </h4>
                        @php
                            $remaining = $this->remainingAmount - $this->totalPayments;
                        @endphp
                        <p class="text-2xl font-bold {{ $remaining <= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
