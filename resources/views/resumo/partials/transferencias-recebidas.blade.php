    ...
    <div class="col-12">
        <div class="d-flex flex-column align-items-center justify-content-center py-5">
            ...
            <p class="mb-4 text-secondary text-center" style="max-width: 480px; font-size:1.15rem; font-weight:500; line-height:1.6;">
                <span style="color:#0d6efd; font-weight:700;">Ops!</span> Não encontramos transferências recebidas para o mês selecionado.<br>
                <span style="color:#6ea8fe;">Aguarde ou registre uma nova transferência</span> para acompanhar seus recebimentos!
            </p>
        </div>
    </div>
    @endforelse
