<x-layouts.app title="Admin - Novo plano">
    <style>
        :root {
            --plan-muted: #64748b;
        ...
        .page-sub { font-size:.84rem;color:var(--plan-muted);margin-top:.2rem; }
        ...
        .form-card { background:rgba(255,255,255,.84);border:1px solid var(--plan-border);border-radius:1.3rem;padding:1.5rem 2rem;margin-bottom:1.5rem;box-shadow:0 18px 32px -26px rgba(15,23,42,.22); }
        .dark .form-card { background:rgba(15,23,42,.78);border-color:var(--plan-border-dark);box-shadow:0 22px 36px -24px rgba(2,6,23,.76); }
        ...
        select.field-input option { background: #111120; }
        ...
        .form-footer { display:flex;gap:.75rem;justify-content:flex-end;padding-top:1.25rem;border-top:1px solid var(--border);margin-top:1.5rem; }
        ...
        @media (max-width: 768px) {
            .plan-form-page { padding: 1rem .75rem max(7.25rem, env(safe-area-inset-bottom)); }
    ...
    <div class="plan-form-page">
        @include('partials.plan-center-nav', [
            ...
            'subtitle' => 'Cadastro no mesmo layout do restante do sistema, sem sidebar paralela.',
        ])
        ...
        <div class="page-header">
            <div class="page-title">Novo Plano</div>
            <div class="page-sub">Preencha as informações abaixo para criar um novo plano.</div>
        </div>
