...
<div
    class="invoice-header-component relative overflow-hidden bg-gradient-to-r from-white/80 via-purple-50/90 to-pink-50/80 dark:from-slate-800/90 dark:via-purple-900/30 dark:to-pink-900/30 backdrop-blur-xl border-b border-white/20 dark:border-slate-700/50 rounded-2xl shadow-xl mb-4">
    ...
    <div class="relative px-4 py-4 md:px-5 lg:px-6">
        <!-- Breadcrumb -->
        @if(isset($breadcrumb))
            {{ $breadcrumb }}
        @endif
        ...
        <div class="invoice-header-top flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 mb-4">
            <div class="invoice-header-brand flex w-full xl:w-auto items-start sm:items-center gap-3 md:gap-4 min-w-0">
                ...
                @else
                    <div class="relative flex items-center justify-center w-16 h-16 min-w-16 min-h-16 max-w-16 max-h-16 md:w-20 md:h-20 md:min-w-20 md:min-h-20 md:max-w-20 md:max-h-20 lg:w-24 lg:h-24 lg:min-w-24 lg:min-h-24 lg:max-w-24 lg:max-h-24 bg-gradient-to-br from-purple-500 via-pink-500 to-rose-500 rounded-2xl shadow-md shadow-purple-400/20 shrink-0">
                        <i class="fas fa-university text-white text-xl md:text-2xl lg:text-3xl"></i>
                    </div>
                @endif
