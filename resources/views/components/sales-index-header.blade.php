...
<div class="sales-index-header relative overflow-hidden bg-gradient-to-r from-white/80 via-blue-50/90 to-indigo-50/80 dark:from-slate-800/90 dark:via-blue-900/30 dark:to-indigo-900/30 backdrop-blur-xl border-b border-white/20 dark:border-slate-700/50 rounded-3xl shadow-2xl mb-6">
    ...
    <div class="relative px-4 py-3 sales-index-header-inner">
        ...
        <div class="sales-index-header-main flex items-center justify-between gap-6 mb-6">
            ...
            @if($sales && !$showSteps)
            <div class="sales-index-header-controls flex items-center gap-3">
                <!-- Campo de Pesquisa -->
                <div class="sales-index-header-search relative group w-96">
                ...
                <!-- Contador -->
                <div class="sales-index-header-counter flex items-center gap-2 px-3 py-2 bg-white/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-600 rounded-xl shadow-md">
                    ...
                    <div class="sales-index-header-quick-filters ml-3 mt-2 sm:mt-0 sm:ml-4">
                        <div class="sales-index-header-quick-filters-row flex items-center gap-2">
                ...
                <button wire:click="toggleTips"
                    class="sales-index-header-btn-tips p-2.5 bg-gradient-to-br from-amber-400 to-orange-500 hover:from-amber-500 hover:to-orange-600 text-white rounded-xl transition-all duration-200 shadow-md hover:shadow-lg hover:scale-105">
                    <i class="bi bi-lightbulb"></i>
                </button>

                <!-- Botão Filtros -->
                <button @click="showFilters = !showFilters"
                    class="sales-index-header-btn-filters p-2.5 bg-white/80 hover:bg-purple-100 dark:bg-slate-800/80 dark:hover:bg-purple-900/50 border border-slate-200 dark:border-slate-600 rounded-xl transition-all duration-200 shadow-md"
