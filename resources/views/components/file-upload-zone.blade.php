            ...
            <label for="{{ $wireModel }}"
                ...
                <div class="flex flex-col items-center justify-center pt-5 pb-6 px-6 text-center">
                    ...
                    @else
                        ...
                        <div class="space-y-6">
                            <div class="relative">
                                <div class="w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-xl group-hover:shadow-2xl transition-shadow duration-300">
                                    <i class="bi bi-cloud-upload text-3xl text-white group-hover:scale-110 transition-transform duration-300"></i>
                                </div>
                                <div class="absolute -inset-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-300 blur"></div>
                            </div>

                            <div class="space-y-3">
                                <h3 class="text-xl font-bold text-neutral-700 dark:text-neutral-300">
                                ...
                                <p class="text-neutral-600 dark:text-neutral-400">
                                    Arquivos suportados: <strong>PDF</strong> ou <strong>CSV</strong> (Máx. {{ $maxSize }})
                                </p>
                            </div>

                            <!-- Ícones dos tipos de arquivo -->
                            <div class="flex items-center justify-center space-x-6">
                                <div class="flex items-center space-x-2 px-3 py-2 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-700">
                                    <i class="bi bi-file-earmark-pdf text-red-500 text-lg"></i>
                                    <span class="text-sm font-medium text-red-700 dark:text-red-300">PDF</span>
                                </div>
                                <div class="flex items-center space-x-2 px-3 py-2 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-700">
                                    <i class="bi bi-file-earmark-spreadsheet text-emerald-500 text-lg"></i>
                                    <span class="text-sm font-medium text-emerald-700 dark:text-emerald-300">CSV</span>
                                </div>
                            </div>
                        </div>
                    @endif
