...
<div class="bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg border border-white/20 dark:border-slate-700/50">
    ...
    <div class="mb-8">
        ...
        <p class="text-sm text-slate-600 dark:text-slate-400 mt-2">
            Preencha as informações do cliente (* campos obrigatórios)
        </p>
    </div>

    <!-- Formulário -->
    <form wire:submit="store" class="space-y-6" x-data="{
        formatPhone(value) {
            ...
            <div class="lg:col-span-2">
                <label for="name" class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">
                    <div class="flex items-center">
                        <div class="w-5 h-5 bg-gradient-to-br from-emerald-500 to-teal-500 rounded flex items-center justify-center mr-2">
                ...
                <div class="relative group">
                    <input type="text"
                           ...
                           class="w-full pl-12 pr-4 py-4 bg-gradient-to-r from-white via-slate-50 to-emerald-50 dark:from-slate-800 dark:via-slate-700 dark:to-emerald-900/30
                                  ...
                                  focus:ring-4 focus:ring-emerald-500/20 focus:border-emerald-500 dark:focus:border-emerald-400
                                  transition-all duration-300 shadow-lg hover:shadow-xl backdrop-blur-sm
                                  text-base font-medium group-hover:border-emerald-300">

                    <!-- Ícone -->
                    <div class="absolute left-4 top-1/2 transform -translate-y-1/2">
                        <i class="bi bi-person text-slate-500 dark:text-slate-400 text-lg group-focus-within:text-emerald-500 transition-colors duration-200"></i>
                    </div>

                    <!-- Efeito de brilho -->
                    <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-emerald-500/10 via-transparent to-teal-500/10 opacity-0 group-focus-within:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                </div>
                @error('name')
                ...
                <div class="relative group">
                    <textarea wire:model="address"
                              ...
                              class="w-full pl-12 pr-4 py-4 bg-gradient-to-r from-white via-slate-50 to-orange-50 dark:from-slate-800 dark:via-slate-700 dark:to-orange-900/30
                                     ...
                                     transition-all duration-300 shadow-lg hover:shadow-xl backdrop-blur-sm
                                     text-base font-medium group-hover:border-orange-300 resize-none"></textarea>

                    <!-- Ícone -->
                    <div class="absolute left-4 top-6 transform -translate-y-1/2">
                        <i class="bi bi-geo-alt text-slate-500 dark:text-slate-400 text-lg group-focus-within:text-orange-500 transition-colors duration-200"></i>
                    </div>

                    <!-- Efeito de brilho -->
                    <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-orange-500/10 via-transparent to-red-500/10 opacity-0 group-focus-within:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                </div>
                @error('address')
                    <div class="mt-3 p-3 bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-lg border border-red-200 dark:border-red-700">
                        <p class="text-sm text-red-600 dark:text-red-400 flex items-center">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-end gap-4 pt-6 border-t border-slate-200/50 dark:border-slate-700/50">
            ...
            <button type="submit"
                ...
                <!-- Efeito hover ring -->
                <div class="absolute inset-0 rounded-2xl bg-emerald-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </button>
        </div>
    </form>
</div>
